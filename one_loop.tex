...
\institute{
  \begin{picture}(100,2)
    \put(230,-90){ \includegraphics[scale=0.12]{m}
    }

    % unlimite food
    % Martin was witness of a competition in a rodizio, which is  with a very strong Brazilian opponent and his support helped me emerge victorious.
    %Martin was witness of a competition in a rodizio with a strong brazilian opponent and his clear support for me, help me to emerge victorious.
\end{picture}
...
\begin{frame}
\includegraphics[scale=0.6]{oneloop}

  \begin{columns}
    \begin{column}{0.7\textwidth}
\only<1>{\includegraphics[scale=0.28]{fig1topologies}}%
\only<2>{\includegraphics[scale=0.4]{oneloopmassbasis}}%      
    \end{column}
    \begin{column}{0.3\textwidth}
      Up to electro-weak triplets
...
%%%%%%%%%%%%%%%
\begin{frame}[fragile]
  \frametitle{Hirsch-subindex $\to$ In the Acknowledgements section}

\fbox{\texttt{ft "martin hirsch" and a AUTHOR}}


\includegraphics[scale=0.4]{hirschsubindex}

José W.F. Valle \fbox{16}  \hspace{0.4cm}\ Avelino Vicente {\color{red}\fbox{12}}  \hspace{0.4cm}\ Diego Aristizabal \fbox{7}  \hspace{0.4cm}\ Diego Restrepo \fbox{7}

\end{frame}

\begin{frame}
  \includegraphics[scale=0.6]{scotoneloop}


  \begin{columns}
    \begin{column}{0.7\textwidth}
\includegraphics[scale=0.35]{t13a}
    \end{column}
    \begin{column}{0.3\textwidth}
      Up to electro-weak triplets
...
\begin{frame}
  \includegraphics[scale=0.6]{SSDM}
    \includegraphics[scale=0.6]{sarah}
\end{frame}

\begin{frame}
  \frametitle{\small Radiative neutrino masses in the singlet-doublet fermion dark matter
model with scalar singlets}
{\tiny \color{blue} Diego Restrepo(Antioquia U.), Andrés Rivera(Antioquia U.), Marta Sánchez-Peláez(Antioquia U.), Oscar Zapata(Antioquia U.), Walter Tangarife(Tel Aviv U.)}\\
{\scriptsize PHYSICAL REVIEW D \textbf{92}, 013005 (2015)}

\begin{columns}
    \begin{column}{0.5\textwidth}
\includegraphics[scale=0.3]{t13atable}

{\scriptsize Like the MSSM bino-Higgsino sector (arbitrary couplings)}

\includegraphics[scale=0.4]{t13amassbasisloop}
    \end{column}
    \begin{column}{0.5\textwidth}
      \only<2>{\includegraphics[scale=0.4]{t13acancelation}}%
      \only<3>{SPHENO

        \includegraphics[scale=0.4]{t13aspheno}}
      \only<4>{MicroMEGAS

        \includegraphics[scale=0.4]{t13amicromegas}}
      \only<5>{MadGraph

        \includegraphics[scale=0.4]{t13amagraph}}
...
\begin{frame}
  \includegraphics[scale=0.55]{minimallagrangian}
  
  \includegraphics[scale=0.5]{minimallagrangianpip}

  \includegraphics[scale=0.3]{minimallagrangiansarah}

  All {\color{red}35 models} implemented
\end{frame}

\begin{frame}
\frametitle{  \includegraphics[scale=0.55]{all1loop}}

\includegraphics[scale=0.42]{fig2scotostable}

\includegraphics[scale=0.1]{dmdecay} See \url{./scotodecay.nb} and \href{https://arxiv.org/pdf/1912.10969.pdf}{Tensor products}
\end{frame}
  ...
  \begin{table}
    \centering
        ...
        \begin{tabular}{c|c|c|c}
          \multicolumn{2}{c|}{Exit models} & \multicolumn{2}{c}{Dark matter models}\\
          SM field in the loop   & Only fields beyond the SM & Stabilizing symmetry & Accidentally stable \\\hline
          38 & 368 & 115 & 203\\
          \multicolumn{2}{c|}{406} & \multicolumn{2}{c}{318}\\
                  \multicolumn{4}{c}{724}
        \end{tabular}
        \caption{ (i)
use only scalars and fermions as BSM fields; and (ii) avoid stable charged relics. “Exits” as particles that can decay into
...
\begin{frame}
  \frametitle{1-loop Dirac neutrinos case}
  \includegraphics[scale=0.55]{diraccase}

  \includegraphics[scale=0.55]{diracminimal}

      \includegraphics[scale=0.55]{diracall.png}
\end{frame}
...
\begin{frame}
  ...
  \vspace{-0.5cm}
    \includegraphics[scale=0.2]{rodizio}
\end{frame}
...
\section{(1-loop) Dirac neutrino masses}
...
\only<1>{
  \begin{block}{1-loop Dirac neutrino masses}
...
\begin{frame}
\frametitle{Weinberg operator at 1-loop}
\begin{picture}(320,250)
