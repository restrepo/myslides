...
\title{Abelian gauge extensions with Higgs mixing}
\subtitle{}
...
\institute{
  \begin{picture}(100,2)
    \put(230,-90){ \includegraphics[scale=0.17]{dulima}
    }
\end{picture}
...
%}
 \collaborators{%Leonardo Leite, Orlando Peres, William Novelo (UNICAMP), David Suárez (UdeA)
   Farinaldo S. Queiroz (IIP), Clarissa Siqueira(São Paulo University)\\ and Carlos Yaguna (UPTC) [\emph{In progress...}]
 }
}
...
\section{Local Abelian extensions of the SM}
...
%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Anomaly cancellation of a gauge $U(1)_{X}$ extension}

  It is known that if we extend the SM by a local $U(1)_X$ and a set of $\alpha$ singlet chiral fields, $N_{\alpha}$, the cubic and mixed gauge anomalies can be written in terms of two $U(1)_X$ charge, e.g, $\color{red}u$ and $\color{red}d$, where $\color{red}u$ and $\color{red}d$ represent the charges of the right-handed up and down quarks, respectively 
\begin{align}
  \label{eq:al0}
  \sum_{\alpha}n^3_{\alpha}&=-   3(2{\color{red}d+u})^3\nonumber\\
   \sum_{\alpha} n_{\alpha}&=-3 (2{\color{red}d+u})\,.
\end{align}
where $n_\alpha$ is the $U(1)_X$-charge of $N_\alpha$.
\end{frame}

\begin{frame}
  \frametitle{$\alpha=3$}
  If the set of $N_\alpha$ is just the set of heavy singlet chiral fields of the type-I seesaw
  \begin{align}
  \sum_{\alpha}n^3_{\alpha}&=-3\nonumber\\
  \sum_{\alpha} n_{\alpha}&=-3\,, \nonumber
  \end{align}
  such that 
\begin{equation}
 2{\color{red}d+u}=1, \rightarrow {\color{red}u}=1-2{\color{red}d}\,.  
\end{equation}
In this way, we can write the solution in terms of just one parameter: $\color{red}d$
\end{frame}

\begin{frame}
  \frametitle{Examples of $\color{magenta}d$ with vector-like Dirac fermionic dark matter and {\color{cyan}mass mixing}}
For a vector-like fermionic dark matter candidate $\color{blue}\chi$, $U(1)_X$ can guarantee the stability
...
\begin{tabular}{|c|c|c|c|c|c|c|c|}
    \hline  
    Fields     & ${SU}(2)_L$ & ${U}(1)_Y $ & ${U}(1)_{X}$& ${U}(1)_{B-L}$& ${U}(1)_R$& ${U}(1)_{\cancel{D}}$& ${U}(1)_{\cancel{U}}$\\ \hline
${\color{red}d}_R $  & $\boldsymbol{1}$& $-1/3$  &  ${\color{red}d}$&  $1/3$&    $1$&  $0$&  $1/2$          \\    
$u_R $  & $\boldsymbol{1}$& $+2/3$  &  $1-2{\color{red}d}$&  $1/3$&   $-1$&  $1$&  $0$      \\
$Q $  & $\boldsymbol{2}$& $1/6$  &  $1/2-{\color{red}d}/2$& $1/3$&    $0$&  $1/2$&  $1/6$     \\\hline
$L $  & $\boldsymbol{2}$& $-1/2$  &  $-3/2+3{\color{red}d}/2$&  $-1$&    $0$ &  $-3/2$&  $-3/4$\\    
 $e_R $  & $\boldsymbol{1}$& $-1$  &  $-2+3{\color{red}d}$&  $-1$&    $1$ &  $-2$&  $-1/2$         \\    
  \hline
 $N_R$& $\boldsymbol{1}$ & $0$ & $-1$& $-1$&  $-1$& $-1$& $-1$\\
 \hline
 $H$& $\boldsymbol{2}$ & $1/2$ & $1/2-3{\color{red}d}/2$& $0$&  $\color{cyan}-1$& $\color{cyan}1/2$& $\color{cyan}-1/4$\\
 $\Phi_s$ & $\boldsymbol{1}$ & $0$ & $2$& $2$& $2$& $2$&$2$\\\hline
 $\color{blue}\chi_L$& $\boldsymbol{1}$ & 0& $1/5$& $1/5$&$1/5$ &$1/5$ &$1/5$\\
 $\color{blue}\chi_R$& $\boldsymbol{1}$ & 0& $1/5$& $1/5$&$1/5$ &$1/5$ &$1/5$\\\hline
  \end{tabular}
\caption{ $\color{red}d$ will be a continuos variable reconverted to rational whenever necessary $\to$ {\color{cyan}mass mixing!}  }
    \label{tab:partcont2}
\end{table}
\end{frame}

\begin{frame}
  \frametitle{Gauged Type-I seesaw with $\color{cyan}\chi$ and {\color{cyan}mass mixing }}

  \begin{equation}
\begin{split}
\label{2hdmtipoI}
\mathcal{L} \supset& y_2 ^d \bar{Q} H d_R + y_2 ^u \bar{Q} \widetilde{H}  u_R + y_2 ^e \bar{L} H e_R + y^{D} \bar{L} \widetilde{H} N_R + Y^{M} \overline{(N_R)^{c}}\Phi_{s}N_R + \text{h.c.}\\
&+i {\color{blue}\bar{\chi}} \gamma_\mu \left(\partial^\mu -ig_{X} \chi {\color{cyan}B^\mu_X}\right) {\color{blue}\chi} - m_{\text{DM}} {\color{blue}\bar{ \chi}} \chi +{\left( \mathcal{D}_\mu{\color{cyan}H} \right)}^{\dagger}\mathcal{D}^\mu {\color{cyan}H}
  +\left( \mathcal{D}_\mu{\Phi_s} \right)^*  \mathcal{D}_\mu{\Phi_s} -V\; ,
\end{split}
\end{equation}
and the scalar potential is,
\begin{equation}
\begin{split}
V =&  \mu^2 H ^\dagger H  + \frac{\lambda}{2} \left( H ^\dagger H \right) ^2  
+ m_s ^2 \Phi _s ^\dagger \Phi _s + \frac{\lambda _s}{2} \left( \Phi _s ^\dagger \Phi _s \right) ^2+ \lambda _{sH} H ^\dagger H \Phi _s ^\dagger \Phi _s 
\end{split}
\label{pot_2hdm_U1}
\end{equation}
where
...
%
\begin{equation}
    \Phi_s= \left( S +v_s + i G^{\prime 0}\right)/\sqrt{2}.
\end{equation}
for any $\psi$
\begin{equation}
\mathcal{L}\supset -\frac{g_X}{4}\left[ (X_R +X_L)\psi \gamma_\mu \psi + (X_R -X_L) \psi \gamma_\mu \gamma_5 \psi\right]{\color{cyan} B^\mu_X},
\end{equation}
...
Neutrino masses are generated via the last two terms of Eq.\eqref{2hdmtipoI}. They induce the presence of Dirac and Majorana mass terms, which consequently lead to the mass matrix,
...
\begin{pmatrix}\nu\\ N_R\end{pmatrix}
\end{equation}
where $m_D=y^D v_2/(2 \sqrt{2})$ and $M_R=y^M v_s/(s \sqrt{2})$. From the diagonalization procedure, we conclude that,
\begin{equation}
    m_\nu = m_D^T m_D/M_R, \,\, m_N = M_R,
\end{equation}for $M_R \gg m_D$.

Therefore, it is clear that our model naturally account for neutrino masses via the type-I seesaw mechanism, and usual can reproduce neutrino oscillation data
  
\end{frame}

\newcommand{\zp}{Z^{\prime}}
\begin{frame}
  \frametitle{Annihilation Rate}
  the main annihilation channels that set the dark matter annihilation rate are indeed those shown in Fig.\ref{fig:diagramas}. The approximate expressions for the annihilation cross-sections are given by,
\begin{eqnarray}
\sigma v  \left( \chi \bar{\chi} \to f \bar{f} \right) &\simeq&  \frac{n_c (1- m_f^2/m_{\chi}^2)^{1/2}}{2\pi M_{Z^{\prime}}^4 (4 m_\chi^2 - M_{Z^{\prime}}^2)^2} \left[2 g_\chi^2  g_{fa}^2 M_{Z^{\prime}}^4 (m_\chi^2-m_f^2) \right. \nonumber \\ 
&+& \left. g_\chi^2 g_{fv}^2 M_{Z^{\prime}}^4 (2 m_\chi^2 +m_f^2) \right],
\end{eqnarray}
where $g_\chi=g_X \chi^2$

\begin{figure}[t!]
    \centering
    \includegraphics[scale=0.44]{diagrama1.png}
     \includegraphics[scale=0.3]{diagrama3.png}
    \includegraphics[scale=0.44]{diagrama2.png}
    \caption{Feynman diagrams that govern the dark matter phenomenology. The first dictates the relic density and the second the scattering rate, including diagrams due to the presence $Z-Z^\prime$ mixing. See the text. }
    \label{fig:diagramas}
\end{figure}
\end{frame}

\section{Isospin violation}

\begin{frame}[fragile]
  \frametitle{Direct detection}
  The spin-independent dark matter-nucleus scattering cross-section induced by a vector current mediated by a $Z'$ of mass $M_{Z'}$
\begin{align}
    \mathcal{L}=
   {\color{cyan} f_\chi} {\overline{\chi}} \gamma^\mu {\chi}\,  Z'_\mu+
    \sum_{\color{red}q=u,d} {\color{red}f_q} \overline{q}\gamma^\mu q \, Z'_\mu\,.
\end{align}
%
where $\color{red}f_{u,d}$ and $\color{cyan}f_\chi$ are the corresponding coefficients of the vector currents
which gives to
\begin{align}
    \mathcal{L}^q_{\text{eff}}=
     \,  
    \sum_{q=u,d}\frac{\color{cyan}f_\chi \color{red}f_q}{M_{Z'}^2} \overline{\chi} \gamma^\mu \chi\overline{q}\gamma_\mu \,q\,.
\end{align}


The nucleon Abelian charge is obtained by summing over the valence quarks of the nucleons 
\begin{align}
    \mathcal{L}_{\text{eff}}=
     \,  
    \sum_{\color{blue}N=p,n}\frac{\color{cyan}f_\chi \color{blue}f_N}{M_{Z'}^2} \overline{\chi} \gamma^\mu \chi\overline{N}\gamma_\mu \,N\,.
\end{align}
where (no contribution of sea quarks or gluons to the effective couplings)
%
\begin{align}
\label{eq:fpfn}
\color{blue}  f_n&=\color{red}f_u+2f_d,\nonumber\\
\color{blue}  f_p&=\color{red}2f_u+f_d\,,
\end{align}

\end{frame}
\begin{frame}[fragile]
    \frametitle{Isospin conservation}


For $U(1)_{B-L}$ $\color{blue}f_n=f_p$ and we can use directly the direct detection proton cross section given by micrOMEGAS and the reported by the direct detection experiments:

\begin{align}
    \sigma_p =&\frac{{\color{cyan}f_\chi\;}^2\mu_p^2}{4\pi M_{Z'}^4}{\color{blue}f_p\;}^2\,,&
\end{align}

\centering
\begin{minipage}[t]{0.5\linewidth}
  \metroset{block=fill}
  \begin{block}{micrOMEGAS output}
    
\begin{verbatim}
CDM-nucleon cross sections[pb]:
 proton  SI 4.440E-10  SD 0.000E+00
 neutron SI 4.440E-10  SD 0.000E+00    
\end{verbatim}
\end{block}
\end{minipage}

  \begin{align*}
    \color{blue}\frac{f_n}{f_p}= &{\color{red}\frac{Q+u+2(Q+d)}{2(Q+u)+Q+d}}
     =1\,.
  \end{align*}
Note that the $X$-charge of the SM Higgs: $H= 0$. Therefore $B^\mu_X= Z^{\;\prime\mu}$.

\end{frame}

\begin{frame}
  \frametitle{Isospin violation}
  In general, $\color{blue}f_n \neq f_p$. The dark matter-nucleon scattering cross-section is
\begin{equation}
\sigma_N^Z = \sigma_p \frac{\sum_i \eta_i \mu_{A_i}^2 \left[Z + (A_i-Z){\color{blue}f_n/f_p}\right]^2 }{\sum_i \eta_i \mu_{A_i}^2 A_i^2}
\end{equation}
where
\begin{align}
     \mu_{A_i} =&\frac{M_{A_i} m_{\chi}}{M_{A_i}+m_{\chi}}\,,
\end{align}
where $\eta_i$ the natural abundance of each isotope $i$, with mass $M_{A_i}$.

\end{frame}
\begin{frame}[fragile]
  \frametitle{Xenon detectors}
We have $A=131$ and $Z=54$, and
\begin{equation}
\label{eq:dmnscs}
\sigma_N^Z =  \frac{ \sigma_p }{A^2}\left[Z + (A-Z){\color{blue}\frac{f_n}{f_p}}\right]^2\,,
\end{equation}
Therefore, the Xenonphobic condition, $\sigma_N^Z =0$, imply 
\begin{align*}
\color{blue}  {f_n}/{f_p}=&-{54}/{77}\approx -0.7\,.
\end{align*}

For the numerical calculation we use the micrOMEGAS amplitudes $\mathcal{A}_p$, $\mathcal{A}_n$:
\vspace{-0.8cm}
...
proton:  SI  -1.009E-09  SD  0.000E+00
neutron: SI  -1.009E-09  SD  0.000E+00
\end{verbatim}
\end{block}
\end{minipage}
\end{center}
...
and
\begin{align}
    \color{blue}\frac{f_n}{f_p}=&\frac{\mathcal{A}_n}{\mathcal{A}_p}
\end{align}

\end{frame}

\begin{frame}
  \frametitle{Mass mixing I}
  Whenever $\color{blue}f_n\ne f_p$ the $X$-charge of the SM Higgs: $H\ne 0$. Therefore $B^\mu_X\ne Z^{\;\prime\mu}$ and
  \begin{align*}
    \color{blue}\frac{f_n}{f_p}&\ne {\color{red}\frac{Q+u+2(Q+d)}{2(Q+u)+Q+d}}\,.
  \end{align*}
  
\end{frame}

\begin{frame}
  \frametitle{Mass mixing II}

  \begin{align}
  \mathcal{L}\supset
  &{\left( \mathcal{D}_\mu{H} \right)}^{\dagger}\mathcal{D}^\mu H
  +\left( \mathcal{D}_\mu{\Phi_s} \right)^*  \mathcal{D}_\mu{\Phi_s} 
\end{align}
We focus in the diagonal part for the first part
\begin{align}
  \mathcal{L}\supset&\frac{1}{2}\left(-\tfrac{1}{2}g_2 W_3^\mu-{g_1}Y_{\Phi} B^\mu-g_X H B^{\mu}_X\right)^2(H^0+v)^2+g_X s B^{\mu}_{X} (S+v_s)^2\,. 
\nonumber\\
  \supset& \delta M^2 W_{3\mu}B_X^\mu+\cdots
\end{align}
where
\begin{align}
\label{eq:deltaM2}
    \delta M^2=\frac{1}{2} g_2g_X H v^2\,.
\end{align}
with leads to the mass eigenstates~[\texttt{Babu:1997st}]
\end{frame}

\begin{frame}
  \frametitle{Mass mixing III}
  \begin{align*}
  \begin{pmatrix}
    A_{\mu}\\
    Z_{\mu}\\
...
\approx&
  \begin{pmatrix}
   \cos \theta_{W} &  \sin \theta_{W}& 0\\
- \sin \theta_{W}& \cos \theta_{W}&\epsilon  \\
\epsilon\sin \theta_{W} &  - \epsilon \cos \theta_{W}& 1\\
  \end{pmatrix}                               
  \begin{pmatrix}
    B_{Y}^{\mu}\\    
    W^{3 \mu}\\
...
\begin{align}
    \epsilon\approx \frac{-\delta M^2}{M_{Z^{\prime}}^{2}-M_{Z}^{2}}\,,
\end{align}
by using eq.~\eqref{eq:deltaM2}
  \begin{columns}
    \begin{column}{0.5\textwidth}
\begin{align}
\label{eq:epsilongX}
  \frac{\epsilon}{g_X}=&-\frac{g_2v^{2}}{M_{Z^{\prime}}^{2}-M_{Z}^{2}}(H/2)\\
  =&-\frac {2\cos\theta_W}{\left( \sqrt{2}G_F  \right)^{1/2}}\frac{M_Z}{M_{Z^{\prime}}^{2}-M_{Z}^{2}}(  H/2).
\end{align}

    \end{column}
    \begin{column}{0.5\textwidth}
The non-zero squared gauge boson masses are
\begin{align*}
M_{Z}^{2} &=\frac{g^{2}_2}{4 \cos ^{2} \theta_{W}}v^2\left[1+O\left(\epsilon^{2}\right)\right] \\
  M_{Z^{\prime}}^{2} &=\frac{g_{X}^{2}}{4}\left(H^{2} v^{2}+s^{2} v_{s}^{2}\right)\left[1+O\left(\epsilon^{2}\right)\right] \nonumber\\
&=\frac{g_{X}^{2}}{2}\left(H^{2}\frac{v^2}{2}+s^{2}\frac{ v_s^{2}}{2}\right)\left[1+O\left(\epsilon^{2}\right)\right]
\end{align*}
    \end{column}
...
\begin{frame}
  \frametitle{Direct detection with mass mixing I}

  \vspace{-0.8cm}
  \begin{align}
   \mathcal{L}_{\text{eff}}^q  \supset&
    \frac{g_X^2\chi}{2M_{Z'}^2}\sum_{q=u,d}\left[  
    Q+q 
   -x_q
   \right]\overline{\chi} \gamma^{\mu} \chi\overline{q}  \gamma_{\mu}q\,,
  \end{align}
  where
  \begin{align}
   \color{red} f_q=&\frac{g_X}{2}(Q+q-x_q). &\color{cyan} f_\chi=& g_X \chi\,.
\end{align}
and
  \begin{align}
    x_q
   =&K\frac{e v_q}{2\cos\theta_W\sin\theta_W}H\,,
  \end{align}
  with
  \begin{align}
    K=\frac{2\cos\theta_W}{\left(\sqrt{2}G_F M_Z^2\right)^{1/2}}
  \end{align}
...
\begin{frame}
  \frametitle{Direct detection with mass mixing II}
\begin{align}
\label{eq:xencon}
\color{blue}  \frac{f_n}{f_p}=\color{red}\frac{f_u+2f_d}{2f_u+f_d}
  =& \frac{5-3{\color{red}d}-2(x_u-2x_d)}{7-9{\color{red}d}-2(2x_u+x_d)}\nonumber\\
  =& \frac{5-3{\color{red}d} -
Ke(2v_d+v_u)2H/(2\cos\theta_W\sin\theta_W)}{7-9{\color{red}d} -
Ke(2v_u+v_d)2H/(2\cos\theta_W\sin\theta_W)
}\,. \nonumber\\
  =& \frac{5-3{\color{red}d} -
Ke(2v_d+v_u)(1-3{\color{red}d})/(2\cos\theta_W\sin\theta_W)}{7-9{\color{red}d} -
Ke(2v_u+v_d)(1-3{\color{red}d})/(2\cos\theta_W\sin\theta_W)
}=y\,. \nonumber\\
\end{align}



We have explored all possible gauge Abelian symmetry from the canonical $B-L$ one without mass mixing at $d=1/3$ until $d=3/2$. For each one we have obtained the dark matter-nucleon scattering cross-section~\eqref{eq:dmnscs}  numerically with micrOMEGAS, by using the reported $\sigma_p$ and the ratio of neutron proton amplitudes to obtain ${\color{blue}f_n/f_p}=\mathcal{A}_n/\mathcal{A}_p$.
  
\end{frame}


\begin{frame}
  \frametitle{Xenonphobic condition I}
  \begin{figure}
    \centering
    \includegraphics[scale=0.7]{newxen}
    \caption{Xenonphobic solutions neglecting mass mixing: dashed; and with mass mixing: solid black }
    \label{fig:newxen}
  \end{figure}
...
\end{frame}
  ...
  \begin{frame}
    \frametitle{Xenonphobic condition I}
    \begin{itemize}
    \item The several solutions are displayed in Fig.~\ref{fig:newxen} along the solid black line, and we can see that for $\color{red}d=9/10$ we can have a suppression of at least five orders of magnitude which depends only in SM parameters.
     \item In Fig.~\ref{fig:newxen} we have also displayed the approximation without mass mixing for $\color{blue}f_n/fp$, along the dashed line. We can see that this approximation is only good in the limit of $H\to 0$ close to the canonical $B-L$ value for $\color{red}d=1/3$.
    \end{itemize}
  \end{frame}

  \begin{frame}
    \frametitle{Conclusion}
    The mass mixing must be taking into account to calculate the dark matter-nucleon scattering cross-section
  \end{frame}
...
%\begin{frame}
%  \frametitle{Xenonphobic condition}
%\end{frame}

\end{document}
\begin{frame}
  \frametitle{Methology based on: {\color{cyan}Costa-Dobrescu-Fox arXiv:1905.13729 [PRL]}  }

\begin{itemize}
\item<1-> From a list of $N-2$ integers,  e.g., for $N$ even
  \begin{align}
    \boldsymbol{q}=\only<1-3>{\left[l_1,l_2,\cdots,l_{n},k_1,k_2,\cdots,k_{n}\right],\qquad n=(N-2)/2\,.}%
                   \only<4->{\left[l_1=2,l_2=3,k_1=-1,k_2=-3\right],\qquad n=2\,.}
  \end{align}
  in the range $\only<1-3>{[-m,m]}\only<4->{[-3,3]}$, build two vector-like solutions of $\only<1-3>{N}\only<4->{6}$ integers,
  \begin{align}
    \boldsymbol{x}=&\only<1-3>{\left[{\color{blue}l_1},{\color{red}k_1},\cdots {\color{Green}k_n},
                     -{\color{blue}l_1},-{\color{red}k_1},\cdots -{\color{Green}k_n},
                     \right]}%
                    \only<4->{\left[{\color{blue}2},{\color{red}-1},{\color{Green}-3},
                     -{\color{blue}2},{\color{red}1},{\color{Green}3},
                     \right]}&
     \boldsymbol{y}=& \only<1-3>{\left[0,0,{\color{blue}l_1},\cdots {\color{red}l_n},-{\color{blue}l_1},\cdots -{\color{red}l_n}  \right]}%
                      \only<4->{\left[0,0,{\color{blue}2},\cdots {\color{red}3},-{\color{blue}2},\cdots -{\color{red}3}  \right]}
  \end{align}
\item<2-> Obtain a (some times) {\color{blue}non vector-like} solution with $z_{\text{max}}=\only<1-3>{2m}\only<4>{2\times 3=6}$ 
  \begin{align}
    \boldsymbol{z}=\boldsymbol{x}\oplus\boldsymbol{y}=\left( \sum_{i=1}^Nx_iy_i^2 \right)\boldsymbol{x}
    +\left( \sum_{i=1}^Nx_i^2y_i \right)\boldsymbol{y}\,,
  \end{align}
\end{itemize}

\vspace{-0.5cm}
\invisible<1-2>{\small
  The parameter space to be explored with $z_{\text{max}}=20$ ($m=10$) has {\color{blue} 96\,153 non vector-like} solutions\only<4>{}
\begin{align}
\text{  \# of $\boldsymbol{q}$ lists} =(2m+1)^{N-2}=
  \begin{cases}
    9261 \to {\color{blue}3} & N=5 \\
    194841 \to {\color{blue}38}& N=6 \invisible<1-3>{\to{\color{blue}[1, -2, -3, 5, 5, -6]}}\\
    \vdots & \vdots\\
    1.6\times 10^{13}\to {\color{blue}65910} & N=12\,, \text{\qquad instead $10^{19}$ }\\
  \end{cases}
\end{align}
}
...
\begin{frame}
  \frametitle{\url{https://pypi.org/project/anomalies/}}
\begin{picture}(320,250)  
  \put(0,15){\includegraphics[scale=0.45]{anomalies}}
\end{picture}
\end{frame}

% \begin{frame}
%   \frametitle{\url{https://restrepo.github.io/Advanced_Computation}}
% \begin{picture}(320,250)  
%   \put(0,15){\includegraphics[scale=0.45]{book}}
% \end{picture}
% \end{frame}

\begin{frame}
  \frametitle{\url{ https://doi.org/10.5281/zenodo.7380817}}
\begin{picture}(320,250)  
  \put(0,15){\includegraphics[scale=0.45]{zenodo2}}
  \put(28,10){\includegraphics[scale=0.1]{encircle}}
\end{picture}
\end{frame}

% \begin{frame}
%   \frametitle{\url{https://pypi.org/project/yukawa/}}
% \begin{picture}(320,250)  
%   \put(0,15){\includegraphics[scale=0.45]{yukawa}}
% \end{picture}
% \end{frame}

\begin{frame}
  \frametitle{Minimal secluded model with SM-singlet massive chiral fermions from SSB: $\operatorname{U}(1)_{\color{magenta}D}$}
\begin{align}
  \mathcal{L}=i \psi_{i}^{\dagger}\cancel{\mathcal{D}}\psi_{i}-\frac{1}{4}V_{\mu\nu} V^{ \mu\nu }+\color{blue} \sum_{i<j}h_{ij} \psi_{i}\psi_j \phi^{(*)} +\text{h.c}
\end{align}
{\color{blue} 96\,153 $\to$ 5\,196
\setlength{\fboxrule}{3 pt}
\fcolorbox{red}{yellow}{multi-component DM}
 ($N=8,12$) $\to$ 142 with three Dirac-fermion DM} \only<2-3>{}

\invisible<1>{
\begin{align}
  \boldsymbol{z}=[1, -2, -2, 4, 5, -7, -7, 8] \to \phi=9 \to [{\color{blue} (1, 8)},{\color{red}(-2, -7)},{\color{Green}(4, 5)}] 
\end{align}
...
\begin{align}
  \setlength{\fboxrule}{3 pt}
  \mathcal{L}\subset
  {\color{blue}h_{(1,8)}\psi_1\psi_{8}\phi^{*} \phi^{(*)}}
  +{\color{red}  \underbrace{\sum_{a,b=1}^{2}h_{(-2a,-7b)}\psi_2\psi_{-7}\phi}_{\displaystyle\text{\fcolorbox{blue}{yellow}{multi-flavor DM}}}}
  +{\color{Green}h_{(4,5)}\psi_4\psi_{5}\phi^{*} \phi^{(*)}}
  +\text{h.c.}
\end{align}
}
}
...
\begin{frame}
  \frametitle{Simplest secluded model with SM-singlet massive chiral fermions from SSB: $\operatorname{U}(1)_{\color{magenta}D}$}
...
\setlength{\fboxrule}{3 pt}
\fcolorbox{red}{yellow}{multi-component DM}
($N=8,12$) $\to$ 41\ \ with two Dirac-fermion DM} \only<2-3>{}



\invisible<1>{
\begin{align}
  \boldsymbol{z}=[1, 2, 2, 4, -5, -5, -7, 8] \to \phi=3 \to [{\color{blue} (1, 2), (2, -5), (-5, 8)},{\color{red}(4, -7)}] 
\end{align}
...
\begin{align*}
  \mathcal{L}\subset
{\color{blue}  \Psi^{\operatorname{T}}\kbordermatrix{
     & 1 & 2 & 2 & -5 & -5& 8  \\
   1 & 0 & h_{(1,2)} & h'_{(1,2)} & 0  & 0 & 0 \\
   2 & h_{(1,2)} & 0 & 0 & h_{(2,-5)}  & h_{(2,-5)} & 0 \\
   2 & h'_{(1,2)} & 0 & 0 & 0  & 0 & 0 \\
  -5 & 0 & h_{(2,-5)} & 0 & 0  & 0 & h_{(-5,8)} \\
  -5 & 0 & h_{(2,-5)} & 0 & 0  & 0 & h'_{(-5,8)} \\
   8 & 0 & 0 & 0 & h_{(-5,8)}  & h'_{(-5,8)} & 0 \\
  }\Psi \phi^{(*)}
  }+{\color{red}h_{(4,-7)}\psi_4\psi_{-7}\phi^{*}}
\end{align*}
}
}
\end{frame}
  ...
  \begin{frame}
    \frametitle{$\operatorname{U}(1)_{\color{magenta}D}$: two dark matter candidates\hfill \tiny{in progress...} }

\includegraphics[scale=1]{relic_abundance_dark_symmetry_graph02}
\hspace{1cm}\includegraphics[scale=1]{relic_abundance_dark_symmetry_graph01}
\hspace{1cm}\includegraphics[scale=1]{dark_matter_conversion_graph}

\vspace{-0.5cm}

$M_{Z_D}<200\,,\text{GeV}$
\includegraphics[scale=0.5]{parameter_space20}\hspace{-2cm} $M_2$ [GeV] \hfill (xBit scan)
...
\begin{frame}
  \frametitle{\invisible<1>{Scotogenic} Majorana neutrino masses and mixings}
      \vspace{0.5cm}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{align*}
        \frac{y}{\Lambda} LLHH \invisible<1>{
        \to \frac{y}{\Lambda}LLHH{{\color{red}\frac{\Phi}{\Lambda} \frac{\Phi^*}{\Lambda}}}}
      \end{align*}      
    \end{column}
    \begin{column}{0.5\textwidth}
      \only<2>{\includegraphics[scale=0.6]{darkscoto}}%
      \only<3>{\includegraphics[scale=0.6]{darkscotomaj}}
    \end{column}
  \end{columns}
  ...
  \invisible<1-2>{
Already found by Chi-Fong Wong in arXiv:2008.08573  (subset with $N\le 9$ and $z_{\text{max}} \le 10$)

\begin{align}
  \boldsymbol{z}=[\underbrace{1, 1}_{\displaystyle{\psi}}, 2, 3, -4, -4, -5, 6] \to \phi=2 \to [\;(1,1)_a ,{\color{blue} (2, -4), (4, -6)},{\color{red}(4, -7)}] 
\end{align}
...
\section{Additional conditions to reduce multiplicity}
%%%%%%%%%%%%%%%%%%
\begin{frame}
...
Decrease the number of charges to be assigned to dark matter particles, $\psi_i$ below\only<2>{}
  \begin{align*}
    ...
    \text{\color{cyan} Secluded case: } && \invisible<1>{\text{\color{magenta}Active case:}}\\
    \left[{\color{red}\nu,\nu, (\nu)}, \psi_{1},\psi_2,\cdots,\psi_{N'} \right]&
    &\invisible<1>{\left[{\color{red}\nu,\nu, (\nu)},{\color{blue}m,m,m}, \psi_{1},\psi_2,\cdots,\psi_{N'} \right]}
  \end{align*}
\begin{align}
  { \color{red}  \chi_1\to \nu_{R1},\cdots, \chi_{N_\nu}\to \nu_{R\, N_\nu},\qquad 2\le N_\nu\le 3\,,}&&
\invisible<1>{   \color{blue}X(L_{i})=-L\,,\ X(H)=h\qquad \to m=L-h }%-h=m-L → h=L-m
\end{align}
  \begin{align*} 
    \mathcal{L}_{\text{eff}} = h_{\nu}^{\alpha i} \, {\color{red}\left( \nu_{R\alpha}\right)^{\dagger}} \, \epsilon_{ab} \, {\color{blue} L_i^a }\,\only<1>{H^{b}}{\only<2>{\color{blue}H^b}} \left(\frac{{\color{Green}\Phi^*}}{\Lambda}\right)^\delta + \text{H.c.},\qquad \text{with $i=1,2,3$}\,,
\end{align*}
$\color{Green}\Phi$ is the complex singlet scalar responsible for the SSB of the anomaly-free gauge symmetry and
\setlength{\fboxrule}{3 pt}
\fcolorbox{red}{yellow}{give mass to \emph{all} $\psi_i$}
\invisible<1>{$\to$
$\cancel{[{\color{red}-4,-4},{\color{blue}1,1,1},5]}$}
\begin{align}
     \label{eq:effcon}
   {\color{Green} \phi}=-\frac{\invisible<1>{(}{\color{red}\nu}\invisible<1>{+{\color{blue}m})}}{\delta}\,, %-\nu-L+h-\delta \phi=0 → \delta \phi= -\nu -L+L-m=-\nu-m
\end{align}
...
\begin{frame}
  \centering
  \includegraphics[scale=0.58]{effsols}
\end{frame}

\begin{frame}
  \frametitle{Multi-component dark matter}
  \begin{figure}
    \centering
    \includegraphics[scale=0.7]{numberall}
     \caption{ }
    \label{fig:number}
\end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{Multi-flavor dark matter}
\begin{figure}
    \centering
    \includegraphics[scale=0.7]{generationall}
    \caption{ 
    }
...
\begin{frame}
    \frametitle{$\operatorname{U}(1)_{\color{cyan}X}$ selection with Dirac-fermionic DM \invisible<1-2>{\hfill \tiny{arXiv: 2103.15328}}}

      \begin{columns}
    \begin{column}{0.7\textwidth}
      \begin{itemize}
      \item<1-> Active symmetry $m=3$
      \item<2-> Effective neutrino mass $\delta=2\to$ $\nu=-5$: 
      \item<3-> Active symmetry: $m=3\to$  $\only<2>{\color{red}}\phi=-(\nu+m)/\delta=1$
      \item<4-> Dirac-fermionic DM: $\only<4>{\color{red}}\left(\psi_L\right)^\dagger \psi_R''\Phi^*\to z_6=-7,\ z_7=8$
      \end{itemize}
    \end{column}
    \begin{column}{0.3\textwidth}
      ...
      %(3, 3, 3, −5, −5, −7, 8)
      \Large $(
      {\only<1->{\color{black}}\only<2>{\color{red}}-5, -5},
      {\only<1->{\color{black}}\only<3>{\color{red}}3,3,3},
      {\only<1->{\color{black}}\only<4>{\color{red}}-7,8})$
...
\invisible<1-2>{\only<1-3>{\includegraphics[height=4.5cm]{GNI}}}\only<4-5>{\includegraphics[scale=0.45]{dmz}}\only<3>{\includegraphics[height=4.5cm]{zeedelta2}}\only<4-5>{\includegraphics[height=4.5cm]{u1blc5}}
...
\section{Beyond SM-fermion singlets}
...
\begin{frame}
  \frametitle{Standard model extended with $\operatorname{U}(1)_{\mathcal{X}={\color{cyan}\only<1>{X}\only<2>{L}}\text{~or~}\color{red}\only<1>{D}\only<2>{B}}$ gauge symmetry}
  \small
  \begin{table}
    \centering
        \rowcolors{1}{RoyalBlue!20}{}
  \begin{tabular}{c|c|c|c}
    \hline  
    Fields     & $\operatorname{SU}(2)_L$ & $\operatorname{U}(1)_Y $ & $\operatorname{U}(1)_{\mathcal{X}={\color{red}\only<1>{D}\only<2>{B}}\text{ or } {\color{blue}\only<1>{X}\only<2>{L}}}$\\ \hline
...
$H $    & $\boldsymbol{2}$& $1/2$  &  $h\invisible<1>{=0}$   \\\hline
$\chi_\alpha $ & $\boldsymbol{1}$& $0$     &  $z_\alpha$   \\\hline
\invisible<1>{ $\left(L'_L\right)^\dagger$      & $\mathbf{2}$ & $1/2$   & $-x'$   \\ 
$L''_R$      & $\mathbf{2}$ & $-1/2$   & $x''$   \\ 
$e'_R$      & $\mathbf{1}$ & $-1$   & $x'$   \\ 
$\left(e''_L\right)^\dagger$      & $\mathbf{1}$ & $1$   & $-x''$ }  \\\hline
$\Phi$      & $\mathbf{1}$ & $0$   & $\phi$\\
\invisible<1>{$S$      & $\mathbf{1}$ & $0$   & $s$}\\ 
  \end{tabular}
  \caption{ \only<1>{LHC: hadronic production and dileptonic decay}\invisible<1>{minimal set of
...
\begin{frame}
  \frametitle{Anomaly cancellation: $\mathcal{X}={\color{cyan}L}$ or ${\color{magenta}B}$: beyond SM-singlet fermions}
...
%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Anomaly cancellation: $\mathcal{X}={\color{cyan}L}$  or ${\color{magenta}B}$}
...
\label{eq:Nalpha}
    z_{1}=&-x'\,, &&& z_{2}=&x''\,,\nonumber\\
   & &\color{blue}z_{2+i}&\color{blue}=L\,,\quad i=1,2,3&&
\end{align}
$\to$
\begin{align}
\label{eq:Qzero}
    9{\color{red}Q}=-\sum_{\alpha=1}^{5}z_\alpha=-x'+x''\color{blue}+L+L+L\,,
\end{align}
$\color{blue}L=0$ ${\to}$ $\operatorname{U(1)}_{\color{red}B}$ but $\color{red}Q=0$ $\cancel{\to}$ $\operatorname{U(1)}_{\color{blue}L}$
\end{frame}
...
\begin{frame}
    \frametitle{$\operatorname{U}(1)_{\color{magenta}B}$ selection: Neutrinos, dark matter and baryogenesis}

      \begin{columns}
    \begin{column}{0.7\textwidth}
      \begin{itemize}
      \item<1-> $\color{blue}L=0$
      \item<2-> Effective Dirac neutrino masses: $\only<2>{\color{red}}\phi=-\nu=-5$
  ...
  \invisible<1-4>{\only<5>{{\color{red}959} solutions }    }
...
\begin{frame}
  \frametitle{Gauge Baryon number scotogenic realization: arXiv:2205.05762 [PRD]}
   with Andrés Rivera (UdeA) and Walter Tangarife (Loyola U.)%Any realization which does not affect anomaly cancellation is allowed

  \begin{columns}
    \begin{column}{0.6\textwidth}
\only<1>{  \includegraphics[scale=0.6]{zee1}      }%
% \only<2-3>{
%\only<1>{\includegraphics[scale=0.6]{zee2}      }%
\end{column}
...
\begin{frame}
  \frametitle{arXiv:2205.05762 [PRD]
    \url{https://github.com/anferivera/DarkBariogenesis}}
...
\begin{frame}
  ...
  A methodology was designed to find all the \emph{universal} gauge Abelian extensions of the standard model:



  All of the extensions can be reformulated as the solution of
  \begin{align*}
    \sum_{\alpha=1}^N z_\alpha=&0\,,&
    \sum_{\alpha=1}^N z_\alpha^3=&0\,,
\end{align*}
which we thoroughly scan in an efficient way until $N=12$ and $\left| z_{\text{max}} \right|=20$

Once the physical conditions are stablished, the full set of self-consistent models are found from a simple data-analysis procedure, providing enough freedom to solve several phenomenological problems.
