...
\date{\tiny May 21, 2019 - SUSY2019 - Corpus Christi } % (optional) \today
...
\begin{frame}
  \frametitle{Background: from William Balunas ATLAS talk at {\tiny Mitchell Conference on Collider, Dark Matter, and Neutrino Physics 2019 }}
...
\begin{frame}
  \frametitle{Isosinglet Dirac fermion dark matter model and Seesaw scale}
...
\only<6>{\put(0,130){\small with A.F Rivera, W. Tangarife,  arXiv:19nn.nnnnn   }}%
