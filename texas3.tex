...
\only<5>{\put(0,130){\small with A.F Rivera, W. Tangarife,  arXiv:1905.NNNNN   }}%
\only<5>{\put(220,60){\begin{overpic}[scale=0.6]{sarah}\end{overpic}}}%
\end{picture}
\end{frame}
...
\includegraphics[scale=0.5]{scalar-SI}
