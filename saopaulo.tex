...
\subtitle{with total Dirac neutrino masses}
...
{}
\arxiv{}
\collaborators{Carlos Yaguna, Julian Calle, Mario Reig, Jose Valle (IFIC Valencia), Oscar Zapata (UdeA) }
}
...
\begin{frame}
  \frametitle{Colored dark matter}
...
\begin{frame}
  ...
  \item Only models with Majorana neutrinos predict processes of total $L=L_e+L_{\mu}+L_{\tau}$ violation, like \alert{neutrino less doublet beta decay} (NLDBD) or its collider equivalent at the LHC for example.
  \item NLDBD is experimentally challenging, specially if there is a massless neutrino in the spectrum.
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{NLDBD prospects for Majorana models with a massless
    neutrino}
  with M.Reig, J.W.F Vale, O. Zapata, arXiv:806.09977
  \centering
  %\includegraphics[scale=0.26]{mee}
\end{frame}

\begin{frame}
  \frametitle{Total lepton number conservation}
  In the near future lepton number conservation could be established.
