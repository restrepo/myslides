...
\invisible<1-5>{\only<6->{
    ...
    If one integer is repetead 3 times can be interpreted as $\mathcal{X}\to X$ symmetry with $N'=N-3$  chiral fields.
}
}
\end{frame}
