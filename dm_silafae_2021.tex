...
\begin{align*}
  \left[\mathrm{SO}(1,3)\right]^{2} \mathrm{U}(1)_{X}:&&  \sum_{\alpha} n_{\alpha}+3 \only<4>{(e-2{\color{blue}l})}\only<5->{{\color{Green}m}}=&0\,,\\
  \left[\mathrm{U}(1)_{X}\right]^{3}\,,&&\sum_{\alpha} n_{\alpha}^3+3 \only<4>{(e-2{\color{blue}l})^3}\only<5->{{\color{Green}m^3}}=&0\,    
\end{align*}
}
