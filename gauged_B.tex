...
$S$      & $\mathbf{1}$ & $0$   & $s$\\
  \end{tabular}
  \caption{$\color{blue}L=e=0$ for $\mathcal{X}=\color{red}B$. Or $\color{red}Q=u=d=0$ for $\mathcal{X}=\color{blue}L$. $i=1,2,3$, $\alpha=1,2,\ldots,N'$  }
    \label{tab:partcont2}
\end{table}
\end{frame}
...
\end{align}
If $\color{red}Q=0$ $\cancel{\to}$ $\operatorname{U(1)}_{\color{blue}L}$
\end{frame}
...
\begin{frame}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \item<3-> $\only<3>{\color{red}}\left(L_L'\right)^\dagger L_R''\Phi^*\to x'=-1,\ x''=6$
      \item<4-> $\only<4>{\color{red}}\left(\chi_L\right)^\dagger \chi_R''\Phi^*\to z_3=-3,\ z_4=-2$
      \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
      \vspace{1cm}
  ...
  \invisible<1-3>{959 solutions from $\sim 400,000$}
