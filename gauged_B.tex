...
\begin{itemize}
\item From a list of $N-2$ integers,  e.g., for $N$ even
  \begin{align}
  ...
  \end{align}
\item Obtain a (some times) {\color{blue}non vector-like} solution with $z_{\text{max}}=2m$ 
  \begin{align}
...
{\small
  The parameter space to be explored with $z_{\text{max}}=20$ ($m=10$) has {\color{blue} 96\,153 non vector-like} solutions\only<2>{}
\begin{align}
\text{  \# of $\boldsymbol{q}$ lists} =(2m+1)^{N-2}=
  \begin{cases}
    9261 \to {\color{blue}3} & N=5 \invisible<1>{\to{\color{blue}[1, 5, -7, -8, 9]}}\\
