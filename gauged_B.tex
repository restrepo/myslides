...
\begin{table}
  ...
  \begin{tabular}{l|c|c|c}\hline
    Field&$SU(2)_L$ & $U(1)_Y$&$\operatorname{U}(1)_B$\\\hline
     ...
     $e_R$      & $\mathbf{1}$ & $-1$   & $e=0$   \\ 
     $\left(L'_L\right)^\dagger$      & $\mathbf{2}$ & $1/2$   & $-x'=-3/5$   \\ 
     $e'_R$      & $\mathbf{1}$ & $-1$   & $x'=3/5$   \\ 
     ...
     $S$      & $\mathbf{1}$ & $0$   & $3$   \\
     $\Phi$      & $\mathbf{1}$ & $0$   & $3$   \\
     ${\sigma}^-_\alpha$      & $\mathbf{1}$ & $1$   & $3/5$   \\
     ${\sigma'}^-_\alpha$      & $\mathbf{1}$ & $-1$   & $-12/5$   \\
     \hline
  \end{tabular}
  \caption{$i=1,2,3$, $\alpha=1,2$ normalized baryon number charges with a global factor $-5/3$.}
