...
\author{Diego Restrepo\\
  \scriptsize{\color{gray}VII \color{YellowGreen}Uniandes \color{yellow}Particle \color{orange} Physics \color{cyan}School}
}
...
{}%
{uniandes}% small image here, use pixel for nothing
{}
%\arxiv{}
%\collaborators{  }
}
