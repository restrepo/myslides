...
\begin{frame}[fragile]
  \begin{columns}
    \begin{column}{0.45\textwidth}
      ...
      \begin{align*}
        \operatorname{SU}(3)_c\times \operatorname{SU}(2)_L\times \operatorname{U}(1)_Y \times Z_2
      \end{align*}
    ...
    {
    \lstset{basicstyle=\ttfamily\scriptsize,emph={g1,g2,g3},
  emphstyle=\color{red}}
