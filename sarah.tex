...
\begin{frame}
\begin{picture}(320,250)
  \only<1->{\put(-24,-22){\begin{overpic}[scale=0.5]{rcf}\end{overpic}}}%
  %edit at: https://docs.google.com/presentation/d/1y3F7x2BMEsmRggJH6bOw57EjcNjZuaP6X6aMYCFaJdA/edit?usp=sharing
\end{picture}
\end{frame}
...
\begin{frame}
  ...
  La consolidación experimental del modelo estándar abre nuevos retos a la enseñanza de la física contemporánea en los pregrados, donde se debería hacer más énfasis en las propiedades generales de las teorías clásicas de campos a la luz de los teoremas de Noether.

  \centering \includegraphics[scale=0.7]{fs}
\end{frame}
