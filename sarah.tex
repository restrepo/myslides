...
\Large
  \begin{align*}
  L=\frac{1}{2}m{\color{magenta} v^2}-V(|\boldsymbol{r}|)=\frac{1}{2}m {\color{magenta}\boldsymbol{v}\cdot\boldsymbol{v}}-V(|\boldsymbol{r}|)\only<2>{.}
\end{align*}

\invisible<1>{
\vspace{3cm}
\begin{flushright}
  \includegraphics[scale=0.3]{men}
\end{flushright}
}
...
\textbf{General}: parameter ${\color{red}\xi}(t,\boldsymbol{x})$ or ${\color{red}v}\xi(t,\boldsymbol{x})$ is constant, e.g, accelerated  system invariance: \emph{\color{red}Local} conservation of $E$ and $\boldsymbol{p}$
...
\end{columns}
                ...
                {                  \small
                \begin{align*}
                 \hspace{-0.3cm} \mathcal{L}=i \left( L \right)^{\dagger}\overline{\sigma}^{\mu}D_{\mu}L-\tfrac{1}{4}W_{\mu\nu}^iW^{\mu\nu}_{i}
