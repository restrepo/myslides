...
%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Effective Dirac neutrino mass operator $\to$ arXiv:2112.09524}
...
\begin{frame}
    \frametitle{$\operatorname{U}(1)_{\color{cyan}X}$ selection \invisible<1-2>{\hfill \tiny{arXiv: 2103.15328}}}
...
\begin{frame}
    \frametitle{$\operatorname{U}(1)_{\color{magenta}B}$ selection}
  ...
  \invisible<1-4>{\only<5>{{\color{red}959} solutions from $\sim 400,000$}  (as in $\operatorname{U}(1)_{\color{red}D}$)   }
