...
\title{Secluded Abelian extensions of the SM}
\subtitle{}
...
\institute{
  \begin{picture}(100,2)
    \put(230,-90){ \includegraphics[scale=0.17]{albufera}
    }
\end{picture}
...
%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Anomaly cancellation of a gauge $U(1)_{\color{cyan}x}$ extension}
  Any \emph{universal} local Abelian extension of the Standard Model can be reduced to a set of integers
\begin{align*}
  \boldsymbol{{\color{blue}S}} = \left[z_1,z_2,\cdots,z_N\right]\,,
\end{align*}
which must satisfy the gravitational anomaly, $\left[\operatorname{SO}(1,3)\right]^2\operatorname{U}(1)_Y$, and the cubic anomaly, $\left[\operatorname{U}(1)_X\right]^3$ conditions:
...
\begin{frame}
  ...
  \centering
  \begin{scriptsize}
    \begin{tabular}{L|R|RRR|R|RRRR}
    %\begin{tabular}{l|ll|lll|l|llll}    
\toprule
                                    \text{Solution} & N  &\color{red} \nu & \delta &     \color{Green}  \phi  & N_D & N_M & G_D & G_M \\
\midrule
(\color{red}5,5,\color{blue}-2,-3,\color{Green}1,-6)&  6 &\color{red}   5 &      1 & \color{Green} -5 &   2 &   0 &   1 &   0 \\
                    (1, -2, 3, 4, 6, -7, -7, -7, 9) &  9 &\color{red}  -7 &      1 &                7 &   3 &   0 &   1 &   0 \\
                  (1, 1, -4, -5, 9, 9, 9, -10, -10) &  9 &\color{red}   9 &      1 &               -9 &   3 &   0 &   2 &   0 \\
                (1, -2, -2, 3, 3, -4, -4, 6, 6, -7) & 10 &\color{red}   6 &      1 &  \boldsymbol{-6} &   3 &   2 &   2 &   2 \\
                (1, -2, -2, 3, 4, -5, -5, 7, 7, -8) & 10 &\color{red}  -5 &      1 &                5 &   4 &   0 &   2 &   0 \\
                (1, -2, -2, 3, 5, -6, -6, 8, 8, -9) & 10 &\color{red}  -6 &      1 &   \boldsymbol{6} &   4 &   0 &   2 &   0 \\
                 (2, 2, 3, 4, 4, -5, -6, -6, -7, 9) & 10 &\color{red}   2 &      1 &               -2 &   4 &   2 &   2 &   2 \\
                (1, 1, 5, 5, 5, -6, -6, -6, -9, 10) & 10 &\color{red}   1 &      1 &               -1 &   4 &   0 &   3 &   0 \\
               (2, 2, 4, 4, -7, -7, -9, -9, 10, 10) & 10 &\color{red}  10 &      2 &               -5 &   3 &   0 &   2 &   0 \\
                (1, 2, 2, -3, 6, 6, -8, -8, -9, 11) & 10 &\color{red}  -8 &      1 &                8 &   4 &   1 &   2 &   1 \\
             (1, -2, -3, 5, 6, -8, -9, 11, 11, -12) & 10 &\color{red}  11 &      1 &              -11 &   4 &   0 &   1 &   0 \\
              (1, 1, -3, 4, 4, -7, 8, -10, -10, 12) & 10 &\color{red} -10 &      2 &                5 &   4 &   0 &   2 &   0 \\
            (1, 1, -2, -2, -4, 6, -10, 11, 12, -13) & 10 &\color{red}  -2 &      1 &                2 &   3 &   2 &   1 &   2 \\
               (3, 4, 4, 4, 4, -5, -8, -8, -11, 13) & 10 &\color{red}  -8 &      1 &                8 &   2 &   4 &   1 &   4 \\
             (4, 4, 5, 6, 6, -9, -10, -10, -11, 15) & 10 &\color{red}   6 &      1 &  \boldsymbol{-6} &   4 &   0 &   2 &   0 \\
           (1, -2, -4, 7, 7, -10, -12, 14, 14, -15) & 10 &\color{red}   14&      1 & \boldsymbol{-14} &   3 &   2 &   1 &   2 \\
             (1, 2, 2, -3, 4, -6, 12, -13, -14, 15) & 10 &\color{red}   2 &      1 &               -2 &   4 &   1 &   1 &   1 \\
              (1, 4, 4, -7, 8, 8, -9, -12, -12, 15) & 10 &\color{red}   8 &      1 &               -8 &   4 &   2 &   2 &   2 \\
            (1, 2, 2, -9, -9, 16, 16, 17, -18, -18) & 10 &\color{red} -18 &      1 &               18 &   3 &   2 &   2 &   2 \\
          (1, -3, -6, 7, -10, 11, -16, 18, 18, -20) & 10 &\color{red}  18 &      2 &               -9 &   4 &   0 &   1 &   0 \\
           (1, -4, 5, -6, -6, 10, -14, 15, 20, -21) & 10 &\color{red}  -6 &      1 &   \boldsymbol{6} &   4 &   0 &   1 &   0 \\
          (2, -3, -6, 7, 12, -14, -14, 17, 20, -21) & 10 &\color{red} -14 &      1 &  \boldsymbol{14} &   4 &   1 &   1 &   1 \\
             (3, 6, 6, -7, 8, 8, -14, -14, -17, 21) & 10 &\color{red} -14 &      1 &  \boldsymbol{14} &   4 &   1 &   2 &   1 \\
          (8, 8, 9, 10, 10, -13, -18, -18, -27, 31) & 10 &\color{red} -18 &      1 &               18 &   4 &   1 &   2 &   1 \\
\bottomrule  
    \end{tabular}
\end{scriptsize}
\caption{ Set }
...
\begin{frame}
   ...
   \begin{itemize}%[4,4,-5,-1,-1,-1] like with a massles protected fermion which does not thermalize
     \item \emph{\color{red}Higgs mechanism}: Singlet scalar $\color{Green}\phi$ acquires a vev and give mass to the dark photon
       \begin{align}
  \mathcal{L}=i \psi_{a}^{\dagger}\overline{\sigma^\mu}\left(\partial_\mu -i g_D Z^D_\mu \right)\psi_{a}-\frac{1}{4}V_{\mu\nu} V^{ \mu\nu }+\color{blue} \sum_{a<b}h_{ab} \psi_{a}\psi_b {\color{Green}\phi^{(*)}} +\text{h.c} {\color{Green}-V(\phi)}\,.
   ...
   \item  $z_\alpha$  are the charges of SM-singlet left-handed chiral fermions with $N\ge 5$
     \begin{itemize}
     ...
     \item $\psi_a$ \emph{\color{red}multi-component dark matter}: massive after
       ...
       with $a=N'+1,\cdots, N$
     \end{itemize}
   \item \emph{\color{red}Larger parameter space}:  Dark photon exclusions instead of $Z'$ 
   \end{itemize}
\end{frame}
...
\end{align*}
  \begin{align*} 
    \mathcal{L}_{\text{eff}} = h_{\nu}^{ij} \, {\color{red}\left( \nu_{R i}\right)^{\dagger}} \, \epsilon_{ab} \, {\color{blue} L_j^a }\,\only<1>{H^{b}}{\only<2>{\color{blue}H^b}} \left(\frac{{\color{Green}\phi^*}}{\Lambda}\right)^\delta + \text{H.c.},\qquad \text{with $i,j=1,2,3$}\,,
\end{align*}
...
\end{align*}
  \begin{align*} 
    \mathcal{L}_{\text{eff}} = h_{\nu}^{aj} \, {\color{red}\left( \nu_{R a}\right)^{\dagger}} \, \epsilon_{bc} \, {\color{blue} L_j^b }\,\only<1>{H^{c}}{\only<2>{\color{blue}H^c}} \left(\frac{{\color{Green}\phi^*}}{\Lambda}\right) + \text{H.c.},\qquad \text{with $j=1,2,3$}\,,
\end{align*}
$\color{Green}\phi$ is the complex singlet scalar responsible for the SSB of the anomaly-free gauge symmetry and
\setlength{\fboxrule}{3 pt}
\fcolorbox{red}{yellow}{give mass to \emph{all} $\psi_a$}
\begin{align*}
   {\color{Green} \phi}=\color{red}-\nu=-5\,,
\end{align*}
...
\begin{frame}
  \frametitle{Minimal secluded model with D-5 effective Dirac neutrino masses}
\begin{align}
  \mathcal{L}=i \psi_{i}^{\dagger}\cancel{\mathcal{D}}\psi_{i}-\frac{1}{4}V_{\mu\nu} V^{ \mu\nu }+\color{blue} \sum_{i<j}h_{ij} \psi_{i}\psi_j \phi^{(*)} +\text{h.c} {\color{Green}-V(\phi)}\,.
\end{align}
{\color{blue} %96\,153 $\to$ 5\,196
\setlength{\fboxrule}{3 pt}
\fcolorbox{red}{yellow}{multi-component DM}
 with two Dirac-fermion DM} \only<2-3>{}
...
\begin{frame}
    \frametitle{$\operatorname{U}(1)_{\color{magenta}D}$: two dark matter candidates without kinetic mixing: $Z_D\to 
      \overline{\nu}\nu$\hfill \tiny{in progress...} }
...
\begin{frame}
  \frametitle{$M_2\gg M_1$ and $g_D=0.1$}
  \includegraphics[scale=0.5]{M2ggM1}%
  \includegraphics[scale=0.5]{mZDvsM1}
\end{frame}
