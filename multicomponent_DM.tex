...
\end{frame}
  ...
  \begin{frame}
    \frametitle{$\operatorname{U}(1)_{\color{cyan}D}$: two dark matter candidates\hfill \tiny{in progress...} }
...
$M_{Z_D}<200\,,\text{GeV}$
\includegraphics[scale=0.5]{parameter_space20} $M_2$ [GeV] \hfill (xBit scan)
...
\begin{frame}
  ...
  A methodology to find all the \emph{universal} gauge Abelian extensions of the standard model is designed.
...
Once the physical conditions are stablished, the full set of self-consistent models are found from a simple data-analysis procedure. With enough freedom to solve several phenomenological problems.
