...
\begin{frame}
  \frametitle{\invisible<1>{Majorana} neutrino masses and mixings}

  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{align*}
       \frac{y}{\Lambda} LLHH \to \frac{y}{\Lambda}LLHH{{\color{red}\frac{\Phi}{\Lambda} \frac{\Phi^*}{\Lambda}}}
      \end{align*}      
    \end{column}
    \begin{column}{0.5\textwidth}
      \vspace{0.3cm}
      \only<1>{\includegraphics[scale=0.6]{darkscoto}}%
      \only<2>{\includegraphics[scale=0.6]{darkscotomaj}}
    \end{column}
  \end{columns}
  ...
  \invisible<1>{
Already found in arXiv:2008.08573 ($N\le 9$ and $z_{\text{max}} \le 10$)
