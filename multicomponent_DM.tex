...
\invisible<1-3>{\includegraphics[scale=0.45]{dmz}}\only<3-4>{\includegraphics[height=4.5cm]{zeedelta2}}\only<5>{\includegraphics[height=4.5cm]{u1blc5}}
...
\section{Half active symmetries: gauged $B$ or $L$}
