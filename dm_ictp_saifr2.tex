...
\date{\tiny Oct 24, 2019 - Dark Universe Workshop

  [PDF: \url{http://bit.ly/darkuniverseworkshop}] } % (optional) \today
...
\begin{columns}
  ...
  \begin{column}{0.7\textwidth}
          \begin{figure}
    \centering
    \only<1>{\includegraphics[scale=0.6]{cmbsoup2}}%
    \only<2>{\includegraphics[scale=0.6]{cmbsoup3}}%
...
\end{align*}
    ...
    \begin{column}{0.35\textwidth}
      \only<1>{ {\small For radiative Dirac models with only $\operatorname{U}(1)_{X}$ see also: }
        ...
        \begin{tiny}
          arXiv:1812.01599, 1901.06402, 1902.07259, 1903.01477, 1904.07407, 1907.08630,
          1907.11557, 1910.09537
        \end{tiny}

        $\mathcal{O}(100)$ new models $\color{red}\sim(-4,-4,5)$
...
{
\usebackgroundtemplate{\includegraphics[height=\paperheight]{latam}}    
  \plain{
  \only<2>{\includegraphics[scale=1]{arvi}}
  
  \only<2>{\small {\color{red}\hfill\url{https://lawphysics.wordpress.com} \qquad lawphysics@gmail.com}}}
}
