...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.65\textwidth}
      ...
      \only<3>{\includegraphics[scale=\rssc]{diracradiativeseesawmajo2}}%
      \only<4->{\includegraphics[scale=\rssc]{diracradiativeseesawmajo1}}%
      \invisible<1-2>{
        \begin{align*}
          \psi=&-\frac{\nu+1}{4}\,,&\eta=&-\frac{\nu+1}{4}\invisible<1-3>{-\color{blue}l}\,,&\sigma=&\frac{1-3\nu}{4}\,.
\end{align*}
      }
    \end{column}
