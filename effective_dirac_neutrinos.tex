...
Deacrese the number of charges to be assigned to dark matter particles, $\psi_i$ below
  \begin{align*}
    &\left[ \chi_1,\chi_2,\cdots,\psi_{1},\psi_2,\cdots,\psi_{N'}\right]&\\
    \text{Secluded case} && \text{Active case}\\
    \left[{\color{red}\nu,\nu, (\nu)}, \psi_{1},\psi_2,\cdots,\psi_{N'} \right]&
    &\left[{\color{red}\nu,\nu, (\nu)},{\color{blue}m,m,m}, \psi_{1},\psi_2,\cdots,\psi_{N'} \right]
  \end{align*}
\begin{align}
  { \color{red}  \chi_1\to \nu_{R1},\cdots, \chi_{N_\nu}\to \nu_{R\, N_\nu},\qquad 2\le N_\nu\le 3\,,}&&
   X(L_{i})=-L\,\ X(\Phi)=\phi \to m=-(L+\phi)\\
\end{align}
  \begin{align*} 
    \mathcal{L}_{\text{eff}} = h_{\nu}^{\alpha i} \, \left( \nu_{R\alpha}\right)^{\dagger} \, \epsilon_{ab} \, {\color{blue} L_i^a }\, H^b \left(\frac{\color{blue}\Phi^*}{\Lambda}\right)^\delta + \text{H.c.},\qquad \text{with $i=1,2,3$}\,,
\end{align*}
$\color{blue}\Phi$ is the complex singlet scalar responsible for the SSB of the anomaly-free gauge symmetry with $D$ or $X$-charge 
\begin{align}
     \label{eq:effcon}
