...
\institute{
  \begin{picture}(100,2)
\put(230,-110){ \includegraphics[scale=0.17]{paul}}
\end{picture}
...
\date{\tiny Oct 16, 2019 - ICTP-SAIFR Program on Particle Physics  [PDF: \url{http://bit.ly/darkictp}] } % (optional) \today
...
\only<3->{\put(250,180){\Large $\color{red}\mathcal{L}=-\frac{1}{4}X_{\mu\nu}X^{\mu\nu}+i\overline{\psi}\cancel{\mathcal{D}} \psi-m \overline{\psi}\psi\,. $   }}%
\only<3->{\put(280,218.5){ \Huge {{\color{red}Local}} $\color{red}U(1)_{X}$  }}%
\only<3->{\put(220,150){
    {\color{red}
    ${\cal D}_\mu=Z_\mu+ig' Z'_\mu:\quad \text{Relic abundance: } \color{red} Z'$ portal}  
  }}%
\only<3->{\put(163,120){\Large  $\overline{f}\cancel{\mathcal{D}} f\ {\color{red}\overline{\psi}\cancel{\mathcal{D}} \psi} $   }}%
...
\begin{frame}
  ...
  \begin{tabular}{c|c|c|c|c|c|c|c}
    \hline  
    Fields     & $\operatorname{SU}(2)_L$ & $\operatorname{U}(1)_Y $ & $\operatorname{U}(1)_{X}$& $\color{red}\operatorname{U}(1)_{B-L}$& $\operatorname{U}(1)_R$& $\operatorname{U}(1)_D$& $\operatorname{U}(1)_G$ \\ \hline
...
%$S$ & $\boldsymbol{1}$ & $0$  & $ 2 \psi_N$& $\color{red}2 \psi_N$&  $2 \psi_N$ & $2 \psi_N$& $2 \psi_N$  \\
 $\sum_\alpha n_{\alpha}$ & $\boldsymbol{1}$ & $0$ & $-3$& $\color{red}-3$&  $-3$ & $-3$& $-3$\\
 $\sum_\alpha n_{\alpha}^{3}$ & $\boldsymbol{1}$ & $0$ & $-3$& $\color{red}-3$&  $-3$ & $-3$& $-3$\\ \hline
  \end{tabular}
...
$\left(\nu_{R1},\nu_{R2},\psi_{N-2},\cdots\right)$     & Ref \\ \hline
    ...
    $\color{red}\left(-\dfrac{2}{3},-\dfrac{2}{3},-\dfrac{4}{3},-\dfrac{1}{3}\right)$&\includegraphics[scale=0.03]{colombia}\tiny  arXiv:1607.04029, S. Patra , W. Rodejohann, C. Yaguna [JHEP] \\
    ...
    $\left( -1,-1,-\dfrac{10}{7},-\dfrac{4}{7},-\dfrac{2}{7},\dfrac{9}{7} \right)$ &\includegraphics[scale=0.03]{colombia}\color{red} \tiny 1808.03352, with N. Bernal, C. Yaguna, Ó. Zapata [PRD]\\
    \hline
   \end{tabular}
...
\begin{column}{0.48\textwidth}
  \only<2>{\includegraphics[scale=0.41]{nomajo1}}%
  \only<3>{\includegraphics[scale=0.41]{nomajo}}%
