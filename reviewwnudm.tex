...
The renmant $\color{magenta}Z_3$ symmetry guarantees the stability of $e$ and the other lightest quark, $d_\alpha$ is accidentally stable.

The two mediators of the interactions are $B_\mu$ and $\color{magenta}H$.
...
\begin{frame}
    \frametitle{\small Effective two-component and two-mediator DM without kinetic mixing: $Z_D\to 
      \overline{\nu}\nu$\hfill \tiny{in progress...} }


\centering
\only<1>{\includegraphics[scale=0.4]{dmsectors}}
\only<2>{\includegraphics[scale=0.2]{twomediator}}

Decoupled inert scalar sector $\to \Delta N_{\text{eff}} = 0$
\end{frame}
