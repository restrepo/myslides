...
\vspace{-1cm}
  ...
  \end{align*}
      ...
      \vspace{-0.7cm}
\begin{align*}
   {\color{Green}\phi}=2 \to \big[\underbrace{(1,1)_a}_{\displaystyle{\psi}} ,{\color{blue} (2, -4), (4, -6)},{\color{red}(3, -5)}\big] 
\end{align*}
...
[\color{red}9,9,9, \underbrace{\color{blue}(1,-10),(1,-10)}_{\displaystyle{\psi}}, \color{magenta}(-4,-5)\big],
\end{align*}
