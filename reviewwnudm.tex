...
\title{Effective two-component and two-mediator dark matter}
\subtitle{}
...
\institute{
  \begin{picture}(100,2)
    \put(230,-90){ \includegraphics[scale=0.17]{Nemo}
    }
\end{picture}
...
%%%%%%%%%%%%%%%
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth,height=10cm]{dmbernal}}
...
\begin{frame}
  \frametitle{Example: Inert doublet model: \hfill \small original ref}

  
  SM + Inert Higgs doublet
  \begin{align*}
    \eta =
    \begin{pmatrix}
      \eta^+\\
...
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{effectivenuMD}}
  \begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{align*}
   \mathcal{L}_{M} =     L \cdot H L \cdot H + \text{h.c}  
      \end{align*}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{align*}
  ...
  \begin{center}
\only<1>{Dark matter}\only<2>{} (radiative) realization $\to Z_2$
  \end{center}
...
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{topologies1}}
...
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{topologies2}}
...
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{scotogenic}}
 ...
 \begin{column}{0.5\textwidth}
   \vspace{-1cm}
    ...
    Name & $SU(2)_L$& $U(1)_Y$& $Z_2$ & $U(1)_L$\\
         ...
         $\color{red}\psi_R$ & $\boldsymbol{1}$ & $0$ & $-$ & $-1$ \\
         $\color{red}\psi_L$ & $\boldsymbol{1}$ & $0$ & $-$ & $-1$ \\
         $\eta$ & $\boldsymbol{2}$ & $1/2$ & $-$ & $0$\\
    $\sigma$ & $\boldsymbol{1}$ & $0$ & $-$ & $0$\\         
  \end{tabular}
\end{center}
    \end{column}
...
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{mediators}}
...
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{u1b-l}}
...
\begin{frame}
  \frametitle{Anomaly cancellation of a U(1) gauge symmetry with chiral fermions}
...
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{sltns}}
...
\begin{frame}
 \includegraphics[scale=0.25]{schannelZprime}   \includegraphics[scale=0.25]{tchannelZprime}  \includegraphics[scale=0.33]{schannelZprimeHiggs}  \includegraphics[scale=0.25]{tchannelZprimeHiggs}  


\includegraphics[scale=0.25]{schannelscalar} \includegraphics[scale=0.25]{tchannelscalar}
...
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{sltnsend}}
...
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{sltnsresults}}
...
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth]{venues}}
...
\fcolorbox{red}{yellow}{multi-component DM}
 with two Dirac-fermion DM particles} \only<2-3>{}
...
\begin{frame}
  \frametitle{{\color{cyan}Multi-component} DM through Effective Dirac neutrino mass operator \hfill \tiny{arXiv:2112.09524}}
Decrease the number of charges to be assigned to dark matter particles, $\psi_i$ below%\only<2>{}
  \begin{align*}
    \left[ \chi_1,\chi_2,\cdots,\psi_{1},\psi_2,\cdots,\psi_{N'}\right]\\
    \text{\color{cyan} Secluded case: } \\
...
\end{align*}
$\color{Green}\phi$ is dark Higgs responsible for the SSB of the anomaly-free gauge symmetry and
\setlength{\fboxrule}{3 pt}
\fcolorbox{red}{yellow}{give mass to \emph{all} $\psi_a$}. $\color{red}\nu_R$ remains massless
\begin{align*}
     \label{eq:effcon}
   {\color{Green} \phi}=-\frac{\color{red}\nu}{\delta}\,,
\end{align*}

{\color{cyan}Multi-component} dark matter model with {\color{cyan}two-mediators}: $Z_D$ and $\color{Green}\phi$
\end{frame}
...
\begin{frame}
    \frametitle{{\color{cyan}Two-component} DM through Effective Dirac neutrino mass operator \hfill \tiny{arXiv:2112.09524}}
Decrease the number of charges to be assigned to dark matter particles, $\psi_i$ below%\only<2>{}
  \begin{align*}
    \left[ \chi_1,\chi_2,\cdots,\psi_{1},\psi_2,\cdots,\psi_{N'}\right]\\
    \text{\color{cyan} Secluded case: } \\
...
{\color{cyan}Two-component} dark matter model with {\color{cyan}two-mediators}: $Z_D$ and $\color{Green}\phi$
\end{frame}
...
{\color{blue} %96\,153 $\to$ 5\,196
\setlength{\fboxrule}{3 pt}
\fcolorbox{red}{yellow}{two-component and two-mediator DM}
 with two Dirac-fermion DM particles} \only<2-3>{}
...
\begin{align*}
  ...
  \mathcal{L}\subset
  {\color{blue}h_{(-3,-2)}\psi_{-3}\psi_{-2}{\color{Green}\phi^*}}
  +{\color{Green}h_{(1,-6)}\psi_1\psi_{-6}\phi^*}
  +\text{h.c.}
\end{align*}
}
}
...
\begin{frame}
  \frametitle{Minimal secluded model with D-5 effective Dirac neutrino masses}
  We assume \emph{\color{red}a minimal} decoupled inert scalar (vev-less) sector 
\begin{align*}
  \mathcal{L}=i \psi_{i}^{\dagger}\cancel{\mathcal{D}}\psi_{i}-\frac{1}{4}V_{\mu\nu} V^{ \mu\nu }+\color{blue} \sum_{i<j}h_{ij} \psi_{i}\psi_j \phi^{(*)} +\text{h.c} {\color{Green}-V(\phi)}\,.
\end{align*}
{\color{blue} %96\,153 $\to$ 5\,196
\setlength{\fboxrule}{3 pt}
\fcolorbox{red}{yellow}{two-component, two-mediator DM with two-flavor scotogenic sector}
 } 


\begin{align*}
  \boldsymbol{z}=[{\color{red}-9,-9,-9}, {\color{blue} 10,10 ,-1,-1,} {\color{Green}4,5 }] \to {\color{Green}\phi}=9 \to [{\color{red} (-9, -9, -9)},{\color{blue}(10, -1),(10, -1)},{\color{Green}(4, 5)}] 
\end{align*}
...
\begin{align}
  \setlength{\fboxrule}{3 pt}
  \mathcal{L}\subset
  {\color{blue}  \underbrace{\sum_{a,b=1}^{2}h_{(10a,-1b)}\psi_{10}\psi_{-1}\phi}_{\displaystyle\text{\fcolorbox{red}{yellow}{multi-flavor scotogenic DM}}}}
  +{\color{Green}h_{(4,5)}\psi_4\psi_{5}\phi^{*} }
  +\text{h.c.}
\end{align}
...
\end{frame}
\begin{frame}
  \frametitle{\invisible<1>{Scotogenic} Majorana neutrino masses and mixings \hfill \tiny{in progress}}
  
  \begin{align*}
    \left[\psi_{1},\psi_2,\cdots,\psi_{N}\right] \only<2>{}\\
  \end{align*}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.5\textwidth}
      \invisible<1>{\includegraphics[scale=0.6]{darkscoto}}%
      %\only<3>{\includegraphics[scale=0.6]{darkscotomaj}}
    \end{column}
  \end{columns}

  
  \invisible<1>{$\color{Green}\phi$ 
\setlength{\fboxrule}{3 pt}
\fcolorbox{red}{yellow}{give mass to \emph{all} $\psi_a$}}
...
\begin{align}
  \setlength{\fboxrule}{3 pt}
  \mathcal{L}\subset
  {\color{blue}h_{(1,8)}\psi_1\psi_{8}\phi^{*}}
  +{\color{red}  \underbrace{\sum_{a,b=1}^{2}h_{(-2a,-7b)}\psi_{-2}\psi_{-7}\phi}_{\displaystyle\text{\fcolorbox{blue}{yellow}{multi-flavor DM}}}}
  +{\color{Green}h_{(4,5)}\psi_4\psi_{5}\phi^{*} }
  +\text{h.c.}
\end{align}
}
...
\begin{frame}
  \frametitle{\invisible<1>{Scotogenic} Majorana neutrino masses and mixings \hfill \invisible<1-2>{\tiny with minimal scalar sector}}
      \vspace{0.5cm}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{align*}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \invisible<1-2>{\includegraphics[scale=0.6]{darkscotomaj}}
    \end{column}
  \end{columns}
