...
\begin{picture}(320,250)  
  ...
  \only<1>{\put(235, -15){{\tiny Credit: Komatsu, ICTP Summer School on Cosmology 2018 {\tiny (Video avalaible)}}}}%
    \only<2>{\put(235, -15){{\tiny \color{white} Nobu São Paulo version}}}%  
...
\def\heifig{3.8cm}
\includegraphics[height=\heifig]{building} \hfill \only<1>{\includegraphics[height=\heifig]{lowweb}}\only<2>{\includegraphics[height=\heifig]{cosmic_web_simulation}}
