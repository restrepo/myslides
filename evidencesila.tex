...
\def\heifig{4.8cm}
\includegraphics[height=\heifig]{building} \hspace{2cm}\only<1>{\includegraphics[height=\heifig]{lowweb}}\only<2>{\includegraphics[height=\heifig]{cosmic_web_simulation}}
