...
&+i {\color{blue}\bar{\chi}} \gamma_\mu \left(\partial_\mu -ig_{X} \chi {\color{cyan}Z'_\mu}\right) {\color{blue}\chi} - m_{\text{DM}} {\color{blue}\bar{ \chi}} \chi +{\left( \mathcal{D}_\mu{\color{cyan}H} \right)}^{\dagger}\mathcal{D}^\mu {\color{cyan}H}
...
for any $\psi$
\begin{equation}
\mathcal{L}\supset -\frac{g_X}{4}\left[ (X_R +X_L)\psi \gamma_\mu \psi + (X_R -X_L) \psi \gamma_\mu \gamma_5 \psi\right]{\color{cyan} Z^{\prime \mu}},
\end{equation}
