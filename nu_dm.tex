...
\subtitle{Collider phenomenology}
...
%%%%%%%%%%%
\begin{frame}
  \frametitle{Discussion - Uniandes School 2014}
...
\begin{frame}
\frametitle{Not-susy $\operatorname{SO}(10)\to \operatorname{SU}(3)_C\times SU(2)_L \times \operatorname{U}(1)_Y \times Z_2 $}
...
{      %\metroset{block=fill}
      \begin{exampleblock}{Example (arXiv:1509.06313)}
      \centering
        Split-SUSY-like spectrum: {\color{red}bino-higgsino-wino}
...
\section{Recast at the LHC Run-I}
