...
\date{\tiny Oct 14, 2019 - Cruzeiro do Sul U.  [PDF: http://bit.ly/darkcdsu] } % (optional) \today
...
\only<3->{\put(280,150){
    ...
    $\color{red} X\overline{X}\to \gamma_{\mathcal{D}}\gamma_{\mathcal{D}}$  
  }}%
\only<3->{\put(160,120){\Large $A_{\mu\nu}{\color{red}\ V^{\mu\nu}} $   }}%
...
\begin{frame}
\frametitle{Or$\cdots$ combine known solutions with $\sum n_{\alpha}=-3$ and $\sum n_{\alpha}^3=-3$}
\begin{columns}
...
$\left(\nu_{R1},\nu_{R2},\psi_{N-2},\cdots\right)$     & Ref \\ \hline
    ...
    \hline
   \end{tabular}
   \caption{Possible solutions with at least two repeated charges and until six chiral fermions.

     For general $\sum n_\alpha=0$ solutions: see {\tiny D.B Costa, \emph{et al}, 1905.13729}}
      \label{tab:sltn5}
\end{table}
...
\begin{frame}
  ...
  \begin{tabular}{c|c|c|c}
    \hline  
    Fields   & $\operatorname{SU}(2)_L$ & $\operatorname{U}(1)_Y $  & $\operatorname{U}(1)_{  \only<3>{\mathcal{D}}\only<4->{X}   }$\\ \hline
$L $  & $\boldsymbol{2}$& $-1/2$&$\only<1-3>{0}\only<4>{{\color{blue}l}      }$ \\    
$Q $  & $\boldsymbol{2}$& $-1/6$&$\only<1-3>{0}\only<4>{-{\color{blue}l}/3   }$ \\
$d_R $& $\boldsymbol{1}$& $-1/2$&$\only<1-3>{0}\only<4>{1+2{\color{blue}l}/3 }$ \\
$u_R $& $\boldsymbol{1}$& $+2/3$&$\only<1-3>{0}\only<4>{-1-4{\color{blue}l}/3}$ \\
$e_R $& $\boldsymbol{1}$& $-1$  &$\only<1-3>{0}\only<4>{1+2{\color{blue}l}   }$ \\
$H $  & $\boldsymbol{2}$& $1/2$& $\only<1-3>{0}\only<4>{-1-{\color{blue}l}   }$\\\hline
$\eta$ & $\boldsymbol{2}$& $1/2$  &$\only<1-3>{1}\only<4>{3/4-\color{blue}l} $ \\
$S$ & $\boldsymbol{1}$& $0$ &$\only<1-3>{2}\only<4>{3/2}$ \\    
$\sigma$ & $\boldsymbol{1}$& $0$ &$\only<1-3>{3}\only<4>{13/4}$ \\\hline        
    $\nu_{R1}$& $\boldsymbol{1}$& $0$ & $\only<1-3>{+}\only<4->{-}4$\\
$\nu_{R2}$& $\boldsymbol{1}$& $0$ & $\only<1-3>{+}\only<4->{-}4$\\
$\nu_{R3}$& $\boldsymbol{1}$& $0$ & $\only<1-3>{-}\only<4->{+}5$\\
$\psi_{R1}$& $\boldsymbol{1}$& $0$ & $\only<1-3>{-1}\only<4->{3/4}$\\
$\psi_{R2}$& $\boldsymbol{1}$& $0$ & $\only<1-3>{-1}\only<4->{3/4}$\\
$\psi_{R3}$& $\boldsymbol{1}$& $0$ & $\only<1-3>{-1}\only<4->{3/4}$\\\hline\hline
\only<1-3>{TOTAL}\only<4->{$\xi_{L\alpha}$} &\only<4->{$\boldsymbol{1}$} &\only<4->{$0$}& $\only<1-3>{0}\only<4->{3/4}$ \\
  \end{tabular}
      }
    \end{column}
  \end{columns}
...
\plain{
  \includegraphics[scale=0.23]{pano}
