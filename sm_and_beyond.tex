...
\begin{itemize}
\item $\cancel{\operatorname{U}(1)}$ Majorana scalars: $\xi^{\alpha}\xi_{\alpha}+\xi^{\dagger}_{ \dot{\alpha}}\xi^{\dagger \dot{\alpha}}$, $\eta^{\alpha}\eta_{\alpha}+\eta^{\dagger}_{ \dot{\alpha}}\eta^{\dagger \dot{\alpha}}$.
...
\begin{block}{General theory: QED $\to {\color{magenta}D_\mu}=i\partial_\mu-i e {\color{magenta}A_\mu}$}

\begin{align*}
  \xi^{\color{red}\alpha}\to\xi^{\,\prime {\color{red}\alpha} }=&e^{i\theta(x)}\xi^{\color{red}\alpha} &   \eta\to\eta'=&e^{-i\theta(x)}\eta \\
\end{align*}
como
\begin{align*}
