...
\begin{frame}[fragile,allowframebreaks]
\textbf{Special}: parameter $\xi$ or $v$ is constant, e.g, inertial system invariance: \emph{\color{red}Global} conservation of $E$ and $\boldsymbol{p}$

\textbf{General}: parameter $\xi(t,\boldsymbol{x})$ or $v\x(t,\boldsymbol{x})$ is constant, e.g, accelerated  system invariance: Local conservation of $E$ and $\boldsymbol{p}$
\end{frame}
