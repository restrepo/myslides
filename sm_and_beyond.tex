...
\begin{frame}%[fragile,allowframebreaks]
\frametitle{\small {\color{magenta}Photon}: \only<1>{Representation of the Poincaré Group}\only<2>{\st{Representation of the Poincaré Group}} which transform as a vector under $\operatorname{SO}(1,3)$}
