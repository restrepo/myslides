...
%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{$\operatorname{SU}(2)_L\invisible<1>{\times\color{cyan}\operatorname{U}(1)_Y}$ 17 years later... (stages of grief $\to$ \only<1-5>{1967}\only<6>{1971}\only<7>{1982}\only<8->{2012})}
...
&\color{red}-\frac{1}{2}m_H^2H^2\left(1+\frac{H}{v}+\frac{H^2}{4v^2}\right)+\left(m_W^2{W^\mu}^-W_\mu^++\frac{1}{2}m_Z^2Z^\mu Z_\mu\right)\left(1+2\frac{H}{v}+\frac{H^2}{v^2}\right)
