...
\end{align}
que genera un elemento del grupo $\operatorname{SO}(1,1)$ con \emph{\color{red}parámetro} $\xi$ 
\begin{align}
...
\begin{frame}%[fragile,allowframebreaks]
\begin{align*}
\cosh\xi=\gamma= \frac{1}{\sqrt{1-v^2}}  
\end{align*}
  
\textbf{Special}: parameter $\xi$ or $v$ is constant, e.g, inertial system invariance: \emph{\color{red}Global} conservation of $E$ and $\boldsymbol{p}$ (still action at a distance!)

\textbf{General}: parameter $\xi(t,\boldsymbol{x})$ or $v\x(t,\boldsymbol{x})$ is constant, e.g, accelerated  system invariance: \emph{\color{red}Local} conservation of $E$ and $\boldsymbol{p}$
...
\begin{block}{Inestability of binary particle systems}
  ...
  \end{columns}
\end{block}
\centering {\color{red}Noether's paradigm}
\end{frame}
