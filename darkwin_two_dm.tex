...
\only<5>{\includegraphics[scale=0.4]{omega35}}%
\end{column}
    \begin{column}{0.5\textwidth}
...
\rowcolors{1}{RoyalBlue!20}{}
    \begin{tabular}{ll}
      ...
      $\color{red}N_{R1}$ & $\color{red}-1$ \\
      $\color{red}N_{R2}$ & $\color{red}-1$ \\  
      $\color{Green}\xi_L $ & $\color{Green}+10/7$ \\
      $\color{Green} \eta_R$ & $\color{Green} -4/7$ \\
      $\color{blue}\zeta_R$ & $\color{blue}-2/7$ \\
      $\color{blue}\chi_L$ & $\color{blue}-9/7$ \\\hline
      $S$ & $-2$ \\
      $S'$ & $1$ \\
    \end{tabular}
    \begin{align*}
