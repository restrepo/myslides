...
\begin{frame}[fragile,allowframebreaks]
  ...
  \begin{tabular}{c|c}
    \hline  
    Fields     &  $\color{red}\operatorname{U}(1)_{B-L}$\\ \hline
$L $  &  $\color{red}-1$ \\    
$Q $    & $\color{red}1/3$     \\
$d_R $  & $\color{red}1/3$      \\
$u_R $  & $\color{red}1/3$      \\
...
$N_{R1}$ & $\color{red}-1$ \\
$N_{R2}$ & $\color{red}-1$ \\    
$\psi_1\to \left( \xi_L \right)^{\dagger}$ & $\color{red}-10/7$ \\
$\psi_2\to \eta_R$ & $\color{red}-4/7$ \\
$\psi_3\to \zeta_R$ & $\color{red}-2/7$ \\
$\psi_4\to \left( \chi_L \right)^{\dagger}$ & $\color{red}+9/7$ \\
$S'$ & $\color{red}1$ \\        
  \end{tabular}
...
\hspace{2cm}    \includegraphics[scale=0.6]{ddd1}

\vspace{1cm}    

\hspace{2cm}    \includegraphics[scale=0.6]{ddd2}
  \end{column}
