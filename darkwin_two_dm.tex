...
\begin{frame}[plain]
\begin{picture}(320,250)
  \only<1>{\put(-10,-12){\includegraphics[height=\paperheight]{paraspace1}}}%
  \only<2>{\put(-10,-12){\includegraphics[height=\paperheight]{paraspace2}}}%
  \only<3>{\put(-10,-12){\includegraphics[height=\paperheight]{paraspace3}}}%
  \only<4>{\put(-10,-12){\includegraphics[height=\paperheight]{paraspace4}}}%
\end{picture}
\end{frame}
