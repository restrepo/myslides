...
$\psi_2\to \color{Green} \eta_R$ & $\color{red}-4/7$ &$\color{Green}\boldsymbol{-}$&$+$ \\
...
\begin{frame}
  ...
  \begin{block}{Boltzman equation}
    $\dfrac{d Y}{d x}=-\dfrac{s\langle\sigma v\rangle}{x H\left(m_{\mathrm{DM}}\right)}\left(Y^{2}-Y_{\mathrm{EQ}}^{2}\right)$
  \end{block}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \small
      \begin{align*} s &=\frac{2 \pi^{2}}{45} g_{\star} \frac{m_{\mathrm{DM}}^{3}}{x^{3}} \\ H\left(m_{\mathrm{DM}}\right) &=\sqrt{\frac{4 \pi^{3}}{45} g_{\star}} \frac{m_{\mathrm{DM}}^{2}}{M_{\mathrm{Pl}}} \\ s Y_{\mathrm{EQ}} &=\frac{g_{\mathrm{DM}}}{2 \pi^{2}} \frac{m_{\mathrm{DM}}^{3}}{x} K_{2}(x) \end{align*}
    \end{column}
    \begin{column}{0.5\textwidth}
\small      
\begin{align*}
  \begin{array}{l}{x=m_{D M} / T} \\ {M_{P l}=1.22 \times 10^{19} \mathrm{GeV} : \text { the Planck mass }} \\ {g_{D M}=2 : \text { the number of DM d.o.f }} \\ {g_{*}=106.75 : \text { for the SM particles }} \\ {K_{2} : \text { the modified Bessel function }}\end{array}
\end{align*}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{sigmav}
    \begin{align*}
      \langle\sigma v\rangle=\frac{g_{D M}^{2}}{64 \pi^{4}}\left(\frac{m_{D M}}{x}\right) \frac{1}{n_{E Q}^{2}} \int_{4 m_{D M}^{2}}^{\infty} d s \hat{\sigma}(s) \sqrt{s} K_{1}\left(\frac{x \sqrt{s}}{m_{D M}}\right)
    \end{align*}
  \end{block}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{block}{Reduced cross section}
        \begin{align*}
          \hat{\sigma}(s)=2\left(s-4 m_{D M}^{2} {\sigma(s)}\right)
        \end{align*}
      \end{block}
    \end{column}
  \end{columns}
