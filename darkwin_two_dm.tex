...
\title{Dark matter from SM gauge extensions}
...
%   affiliation.
\institute{\affiliation{\tiny Instituto de Física\\
...
{}
\arxiv{}
\collaborators{ M. Hirsch (IFIC), C. Álvarez (UTFSM), A. Flórez (UniAndes), B. Dutta(Texas A\& M), C. Yaguna (UPTC), J. Calle, O. Zapata, A. Rivera (UdeA), W. Tangarife (Loyola University Chicago)  }
}
...
$\left(N_R,N_R,\psi_{N-2},\cdots\right)$     & Ref \\ \hline
    $\left(-1,-1,-1\right)$&\cite{}\\
    $\left(-4,-4,+5\right)$&\cite{Montero:2007cd}\\
    $\left(-\dfrac{2}{3},-\dfrac{2}{3},-\dfrac{4}{3},-\dfrac{1}{3}\right)$&\cite{Patra:2016ofq}\\
    $\left(-\dfrac{8}{5},-\dfrac{8}{5},-\dfrac{2}{5},-\dfrac{7}{5},+2\right)$&\cite{Calle:2018ovc}\\
    ...
    $\color{red}\left( -1,-1,-\dfrac{10}{7},-\dfrac{4}{7},-\dfrac{2}{7},\dfrac{9}{7} \right)$ & \cite{Bernal:2018aon}\\
    \hline
   \end{tabular}
      \caption{The possible solutions of the Dirac neutrino mass models with at least two repeated charges and until five chiral fermions.}
      \label{tab:sltn5}
\end{table}
...
$L $  & $\boldsymbol{2}$& $-1/2$  &  $l$&  $\color{red}-1$&    $0$ &  $-3/2$&  $-1/2$ \\    
$Q $  & $\boldsymbol{2}$& $-1/6$  &  $-l/3$& $\color{red}1/3$&    $0$&  $1/2$&  $1/6$ \\
$d_R $  & $\boldsymbol{1}$& $-1/2$  &  $1+2l/3$&  $\color{red}1/3$&    $1$&  $0$&  $2/3$ \\
$u_R $  & $\boldsymbol{1}$& $+2/3$  &  $-1-4l/3$&  $\color{red}1/3$&   $-1$&  $1$&  $-1/3$ \\
$e_R $  & $\boldsymbol{1}$& $-1$  &  $1+2l$&  $\color{red}-1$&    $1$ &  $-2$&  $0$ \\
$H $  & $\boldsymbol{2}$& $-1/2$  &  $-1-l$&  $\color{red}0$&    $-1$ &  $1/2$&  $-1/2$ \\\hline
$S$ & $\boldsymbol{1}$ & $0$  & $ 2 \psi_N$& $\color{red}2 \psi_N$&  $2 \psi_N$ & $2 \psi_N$& $2 \psi_N$ \\
 ...
 $\sum_\alpha \psi_{\alpha}^{3}$ & $\boldsymbol{1}$ & $0$ & $-3$& $\color{red}-3$&  $-3$ & $-3$& $-3$\\
  \end{tabular}
...
\begin{frame}
  \frametitle{100\% $\color{Green}\chi_1$}
...
In this extension of the SM by an $\operatorname{U}(1)_{B-L}$ gauge symmetry amomalies are are canceled partially by two right-handed neutrinos and partially by two component DM Dirac fermions. providing a connection between neutrinos and DM analogous to that one between leptons and quarks in the SM.


The model predicts the existence of three scalar fields beyond the SM Higgs: $H_1$, $H_2$, $A$

Model implemented in both LanHEP. Implemented also in SARAH~{\tiny \url{https://github.com/restrepo/BSM-Submodules/tree/B-L+DM/BSM/SARAH/Models/B-L/DM} (Tested with SARAH-4.14.1)} to analyse perturbativity and stability conditions and higher scales with two-loop RGEs.
