...
\institute{
  \begin{picture}(100,2)
\put(230,-110){ \includegraphics[scale=0.17]{natal}}
\end{picture}
...
\date{\tiny Sep 6, 2019 - Darkwin - Natal [PDF: http://bit.ly/darkwin] } % (optional) \today
...
In the following discussion we use the following doublets in Weyl Notation
\begin{align}
  H=&
  \begin{pmatrix}
    H^+\\
...
\only<2-3>{\put(224,195){ {\huge \only<2>{\textbf{3 models}}\only<3->{
...
\only<4->{\put(124,218.5){ \Huge \invisible<4>{{\color{red}Lo}{\color{Yellow}cal}} $U(1)_X \color{red} \to  Z_7 $  }}%
\only<5>{\put(204,18){ \begin{overpic}[scale=0.2]{tcdm}\end{overpic}}}%
\end{picture}
\end{frame}
...
which satisfy
\begin{align}
\mathrm{U}(1)_{Y}\left[\mathrm{U}(1)_{X}\right]^{2} :&&  
\left[(-2) e^{2}+3\left(\tfrac{4}{3}\right) u^{2}+3\left(-\tfrac{2}{3}\right) d^{2}\right]-\left[2(-1) l^{2}+3 \cdot 2\left(\tfrac{1}{3}\right) q^{2}\right]=&0
\end{align}
}
\invisible<1-3>{
The most general cancellation for $\left[\mathrm{U}(1)_{X}\right]^{3}$ and  $  \left[\mathrm{SO}(1,3)\right]^{2} \mathrm{U}(1)_{X} $ is between families
\begin{align}
\sum_{\alpha} \psi_{\alpha}^3+3 (e-2l)^3=&0\,, &     \sum_{\alpha} \psi_{\alpha}+3 (e-2l)=&0\,, &
\end{align}
with $\alpha=1,2,\cdots,N$ or $X=Y$. We study the set of solutions with $\color{blue}e-2l=1$, e.g
\begin{align}
  \sum_{\alpha} \psi_{\alpha}^3=&-3\,, & \sum_{\alpha} \psi_{\alpha}=&-3\,,
\end{align}
}
\invisible<1-4>{
We impose $N_R=\psi_N=\psi_{N-1}$, to have at most one massless neutrino.
}
\invisible<1-5>{}
\end{frame}

\begin{frame}
\frametitle{  Known solutions with $\sum \psi_{\alpha}=-3$ and $\sum \psi_{\alpha}^3=-3$}
...
$\left(N_R,N_R,\psi_{N-2},\cdots\right)$     & Ref \\ \hline
    $\left(-1,-1,-1\right)$&\tiny hep-ph/0611205, S. Khalil  [JPG] \\
    $\left(-4,-4,+5\right)$&\includegraphics[scale=0.03]{brazil}\tiny arXiv:0706.0473, Montero, V. Pleitez [PLB]\\
    ...
    $\left(-\dfrac{8}{5},-\dfrac{8}{5},-\dfrac{2}{5},-\dfrac{7}{5},+2\right)$&\includegraphics[scale=0.03]{colombia}\tiny arXiv:1812.05523, with J. Calle, C. Yaguna, Ó. Zapata [PRD]\\
    ...
    $\color{red}\left( -1,-1,-\dfrac{10}{7},-\dfrac{4}{7},-\dfrac{2}{7},\dfrac{9}{7} \right)$ &\includegraphics[scale=0.03]{colombia}\color{red} \tiny 1808.03352, with N. Bernal, C. Yaguna, Ó. Zapata [PRD]\\
    \hline
   \end{tabular}
      \caption{The possible solutions of the Dirac neutrino mass models with at least two repeated charges and until six chiral fermions.}
      \label{tab:sltn5}
\end{table}
...
\begin{frame}
  \frametitle{$\operatorname{U}(1)_X$ with two Majorana masses: $\psi_N$, $\psi_{N-1}$  }
        \rowcolors{1}{RoyalBlue!20}{}
  \begin{tabular}{c|c|c|c|c|c|c|c}
    \hline  
    Fields     & $\operatorname{SU}(2)_L$ & $\operatorname{U}(1)_Y $ & $\operatorname{U}(1)_{X}$& $\color{red}\operatorname{U}(1)_{B-L}$& $\operatorname{U}(1)_B$& $\operatorname{U}(1)_D$& $\operatorname{U}(1)_G$\\ \hline
$L $  & $\boldsymbol{2}$& $-1/2$  &  ${\color{blue}l}$&  $\color{red}-1$&    $0$ &  $-3/2$&  $-1/2$ \\    
$Q $  & $\boldsymbol{2}$& $-1/6$  &  $-{\color{blue}l}/3$& $\color{red}1/3$&    $0$&  $1/2$&  $1/6$ \\
$d_R $  & $\boldsymbol{1}$& $-1/2$  &  $1+2{\color{blue}l}/3$&  $\color{red}1/3$&    $1$&  $0$&  $2/3$ \\
$u_R $  & $\boldsymbol{1}$& $+2/3$  &  $-1-4{\color{blue}l}/3$&  $\color{red}1/3$&   $-1$&  $1$&  $-1/3$ \\
$e_R $  & $\boldsymbol{1}$& $-1$  &  $1+2{\color{blue}l}$&  $\color{red}-1$&    $1$ &  $-2$&  $0$ \\
$H $  & $\boldsymbol{2}$& $-1/2$  &  $-1-{\color{blue}l}$&  $\color{red}0$&    $-1$ &  $1/2$&  $-1/2$ \\\hline
$S$ & $\boldsymbol{1}$ & $0$  & $ 2 \psi_N$& $\color{red}2 \psi_N$&  $2 \psi_N$ & $2 \psi_N$& $2 \psi_N$ \\

 $\sum_\alpha \psi_{\alpha}$ & $\boldsymbol{1}$ & $0$ & $-3$& $\color{red}-3$&  $-3$ & $-3$& $-3$\\
 $\sum_\alpha \psi_{\alpha}^{3}$ & $\boldsymbol{1}$ & $0$ & $-3$& $\color{red}-3$&  $-3$ & $-3$& $-3$\\ \hline
  \end{tabular}
  ...
  \alert{All previous $\operatorname{U}(1)_{B-L}$ (radiative) neutrino solutions apply for $\operatorname{U}(1)_X$}
\end{frame}
...
\small
  ...
  \begin{tabular}{c|c|c|c}
    \hline  
    Fields     &  $\color{red}\operatorname{U}(1)_{B-L}$& $Z^1_2$& $Z^1_2$\\ \hline
    $L $  &  $\color{red}-1$ &$+$&$+$  \\    
$Q $    & $\color{red}1/3$ &$+$&$+$    \\
$d_R $  & $\color{red}1/3$ &$+$&$+$     \\
$u_R $  & $\color{red}1/3$ &$+$&$+$     \\
...
$H $    & $\color{red}0$   &$+$&$+$     \\\hline
$S$     & $\color{red}-2 $ &$+$&$+$ \\
$\color{red}N_{R1}$ & $\color{red}-1$ &$+$&$+$\\
$\color{red}N_{R2}$ & $\color{red}-1$ &$+$&$+$\\    
$\psi_1\to \color{Green}\left( \xi_L \right)^{\dagger}$ & $\color{red}-10/7$ &$\color{Green}\boldsymbol{-}$&$+$ \\
$\psi_2\to \color{Green} \eta_RX$ & $\color{red}-4/7$ &$\color{Green}\boldsymbol{-}$&$+$ \\
$\psi_3\to \color{blue}\zeta_R$ & $\color{red}-2/7$ &$+$&$\color{blue}\boldsymbol{-}$\\
$\psi_4\to \color{blue}\left( \chi_L \right)^{\dagger}$ & $\color{red}+9/7$ &$+$&$\color{blue}\boldsymbol{-}$ \\
$S'$ & $\color{red}1$ &$+$&$+$\\        
  \end{tabular}
  
    \end{column}
  \begin{column}{0.6\textwidth}
    \includegraphics[scale=0.5]{seesawm}


\hspace{2cm}   
\only<1>{
  \begin{center}
    After integrating out heavy fermions, we obtain\\
    \alert{light neutrino masses}

    \includegraphics[scale=0.3]{shadedboxn}

    With only two heavy fermions, \alert{one massless neutrino} is left
  \end{center}
}
\only<2>{
  \begin{center}
    {\color{Green}Two} {\color{blue}component} Dirac fermion dark matter
    \begin{align*}
      &\includegraphics[scale=0.6]{ddd1} &  \includegraphics[scale=0.6]{ddd2}& \\
      {\color{Green}\chi_1=}&{\color{Green}
      \begin{pmatrix}
        \xi_L \\ \eta_R        
      \end{pmatrix}},&
      {\color{blue}\chi_2=
      \begin{pmatrix}
        \chi_L \\ \zeta_R
      \end{pmatrix}}&\\
      \mathcal{L}=&{\color{Green}M_1 \overline{\chi_1} \chi_1}  &  +{\color{blue}M_2 \overline{\chi_2} \chi_2}&
    \end{align*}
  \end{center}
}
  \end{column}
...
\begin{frame}[plain]
\begin{picture}(320,250)
  \only<1>{\put(-25,-12){\includegraphics[height=\paperheight]{paraspace1}}}%
  \only<2>{\put(-25,-12){\includegraphics[height=\paperheight]{paraspace2}}}%
  \only<3>{\put(-25,-12){\includegraphics[height=\paperheight]{paraspace3}}}%
  \only<4>{\put(-25,-12){\includegraphics[height=\paperheight]{paraspace4}}}%
\end{picture}
\end{frame}
